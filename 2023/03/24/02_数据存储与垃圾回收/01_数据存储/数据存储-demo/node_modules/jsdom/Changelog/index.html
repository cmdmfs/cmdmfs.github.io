<!DOCTYPE html><html lang="zh-Hans"><head><meta charset="UTF-8"><meta http-equiv="X-UA-Compatible" content="IE=edge"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="format-detection" content="telephone=no"><meta name="apple-mobile-web-app-capable" content="yes"><meta name="apple-mobile-web-app-status-bar-style" content="black"><link rel="icon" href="/images/icons/favicon-16x16.png?v=2.8.0" type="image/png" sizes="16x16"><link rel="icon" href="/images/icons/favicon-32x32.png?v=2.8.0" type="image/png" sizes="32x32"><meta name="description" content="jsdom Changelog                             16.5.3        Fixed infinite recursion when using MutationObservers to observe elements inside a MutationObserver callback.">
<meta property="og:type" content="article">
<meta property="og:title" content="汪汪队">
<meta property="og:url" content="http://example.com/2023/03/24/02_%E6%95%B0%E6%8D%AE%E5%AD%98%E5%82%A8%E4%B8%8E%E5%9E%83%E5%9C%BE%E5%9B%9E%E6%94%B6/01_%E6%95%B0%E6%8D%AE%E5%AD%98%E5%82%A8/%E6%95%B0%E6%8D%AE%E5%AD%98%E5%82%A8-demo/node_modules/jsdom/Changelog/index.html">
<meta property="og:site_name" content="汪汪队">
<meta property="og:description" content="jsdom Changelog                             16.5.3        Fixed infinite recursion when using MutationObservers to observe elements inside a MutationObserver callback.">
<meta property="og:locale">
<meta property="article:published_time" content="2023-03-24T12:24:35.956Z">
<meta property="article:modified_time" content="1985-10-26T08:15:00.000Z">
<meta property="article:author" content="汪汪队">
<meta name="twitter:card" content="summary"><title>[ Untitled ] | 汪汪队</title><link ref="canonical" href="http://example.com/2023/03/24/02_%E6%95%B0%E6%8D%AE%E5%AD%98%E5%82%A8%E4%B8%8E%E5%9E%83%E5%9C%BE%E5%9B%9E%E6%94%B6/01_%E6%95%B0%E6%8D%AE%E5%AD%98%E5%82%A8/%E6%95%B0%E6%8D%AE%E5%AD%98%E5%82%A8-demo/node_modules/jsdom/Changelog/"><link rel="dns-prefetch" href="https://cdn.jsdelivr.net"><link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@5.12.1/css/all.min.css" type="text/css"><link rel="stylesheet" href="/css/index.css?v=2.8.0"><link rel="stylesheet" href="css/custom.css"><script>var Stun = window.Stun || {};
var CONFIG = {
  root: '/',
  algolia: undefined,
...
window.CONFIG = CONFIG;</script><meta name="generator" content="Hexo 6.3.0"></head><body><div class="container" id="container"><header class="header" id="header"><div class="header-inner"><nav class="header-nav header-nav--fixed"><div class="header-nav-inner"><div class="header-nav-menubtn"><i class="fas fa-bars"></i></div><div class="header-nav-menu"><div class="header-nav-menu-item"><a class="header-nav-menu-item__link" href="/"><span class="header-nav-menu-item__icon"><i class="fas fa-home"></i></span><span class="header-nav-menu-item__text">Home</span></a></div><div class="header-nav-menu-item"><a class="header-nav-menu-item__link" href="/archives/"><span class="header-nav-menu-item__icon"><i class="fas fa-folder-open"></i></span><span class="header-nav-menu-item__text">Archives</span></a></div></div><div class="header-nav-mode"><div class="mode"><div class="mode-track"><span class="mode-track-moon"></span><span class="mode-track-sun"></span></div><div class="mode-thumb"></div></div></div></div></nav><div class="header-banner"><div class="header-banner-info"><div class="header-banner-info__title">Hello Stun</div><div class="header-banner-info__subtitle">An elegant theme for Hexo</div></div></div></div></header><main class="main" id="main"><div class="main-inner"><div class="content-wrap" id="content-wrap"><div class="content" id="content"><!-- Just used to judge whether it is an article page--><div id="is-post"></div><div class="post"><header class="post-header"><h1 class="post-title">[ Untitled ]</h1><div class="post-meta"><span class="post-meta-item post-meta-item--createtime"><span class="post-meta-item__icon"><i class="far fa-calendar-plus"></i></span><span class="post-meta-item__info">Created</span><span class="post-meta-item__value">2023-03-24</span></span><span class="post-meta-item post-meta-item--updatetime"><span class="post-meta-item__icon"><i class="far fa-calendar-check"></i></span><span class="post-meta-item__info">Updated</span><span class="post-meta-item__value">1985-10-26</span></span></div></header><div class="post-body">
        <h1 id="jsdom-Changelog"   >
          <a href="#jsdom-Changelog" class="heading-link"><i class="fas fa-link"></i></a><a href="#jsdom-Changelog" class="headerlink" title="jsdom Changelog"></a>jsdom Changelog</h1>
      <!-- Style guide:
...
-->
        ...
        <h2 id="16-5-3"   >
          <a href="#16-5-3" class="heading-link"><i class="fas fa-link"></i></a><a href="#16-5-3" class="headerlink" title="16.5.3"></a>16.5.3</h2>
      <ul>
<li>Fixed infinite recursion when using <code>MutationObserver</code>s to observe elements inside a <code>MutationObserver</code> callback.</li>
        ...
        <h2 id="16-5-2"   >
          <a href="#16-5-2" class="heading-link"><i class="fas fa-link"></i></a><a href="#16-5-2" class="headerlink" title="16.5.2"></a>16.5.2</h2>
      <ul>
...
<li>On Node.js v14.6.0+ where <code>WeakRef</code>s are available, fixed <code>NodeIterator</code> to no longer stop working when more than ten <code>NodeIterator</code> instances are created, and to use less memory due to inactive <code>NodeIterator</code>s sticking around. (ExE-Boss)</li>
        ...
        <h2 id="16-5-1"   >
          <a href="#16-5-1" class="heading-link"><i class="fas fa-link"></i></a><a href="#16-5-1" class="headerlink" title="16.5.1"></a>16.5.1</h2>
      <ul>
...
<li>Fixed <code>window.event</code> to have a setter which overwrites the <code>window.event</code> property with the given value, per the specification. This fixes an issue where after upgrading to jsdom v16.5.0 you would no longer be able to set a global variable named <code>event</code> in the jsdom context.</li>
        ...
        <h2 id="16-5-0"   >
          <a href="#16-5-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#16-5-0" class="headerlink" title="16.5.0"></a>16.5.0</h2>
      <ul>
...
<li>Fixed the <code>new File()</code> constructor to no longer convert <code>/</code> to <code>:</code>, per <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/w3c/FileAPI/issues/41" >a pending spec update</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>.</li>
...
<li>Fixed <code>&lt;input type=checkbox&gt;</code> and <code>&lt;input type=radio&gt;</code> to be mutable even when disabled, per <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/whatwg/html/pull/5805" >a spec update</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>.</li>
...
<li>Fixed a potential memory leak with custom elements (although we could not figure out how to trigger it). (soncodi)</li>
        ...
        <h2 id="16-4-0"   >
          <a href="#16-4-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#16-4-0" class="headerlink" title="16.4.0"></a>16.4.0</h2>
      <ul>
...
<li>Fixed <code>translate=&quot;&quot;</code> and <code>draggable=&quot;&quot;</code> attribute processing to use ASCII case-insensitivity, instead of Unicode case-insensitivity. (zjffun)</li>
        ...
        <h2 id="16-3-0"   >
          <a href="#16-3-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#16-3-0" class="headerlink" title="16.3.0"></a>16.3.0</h2>
      <ul>
...
<li>Fixed drawing an empty canvas into another canvas. (zjffun)</li>
        ...
        <h2 id="16-2-2"   >
          <a href="#16-2-2" class="heading-link"><i class="fas fa-link"></i></a><a href="#16-2-2" class="headerlink" title="16.2.2"></a>16.2.2</h2>
      <ul>
...
<li>Fixed running jsdom in a browser to detect globals more reliably. (ExE-Boss)</li>
        ...
        <h2 id="16-2-1"   >
          <a href="#16-2-1" class="heading-link"><i class="fas fa-link"></i></a><a href="#16-2-1" class="headerlink" title="16.2.1"></a>16.2.1</h2>
      <ul>
...
<li>Updated Acorn-related packages to squelch <code>npm audit</code> warnings.</li>
        ...
        <h2 id="16-2-0"   >
          <a href="#16-2-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#16-2-0" class="headerlink" title="16.2.0"></a>16.2.0</h2>
      <ul>
<li>Added support for custom elements! Congratulations and thanks to <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/jsdom/jsdom/commits?author=pmdartus" >@pmdartus</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span> for making this happen, after ten months of hard work and lots of effort poured into the complex architectural prerequisites in jsdom and supporting packages.</li>
...
<li>Fixed edge cases in number&#x2F;string conversion used for certain element properties that reflected integer attributes.</li>
        ...
        <h2 id="16-1-0"   >
          <a href="#16-1-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#16-1-0" class="headerlink" title="16.1.0"></a>16.1.0</h2>
      <ul>
...
<li>Fixed various issues with <code>setTimeout()</code>, <code>setInterval()</code>, and <code>requestAnimationFrame()</code>, particularly around window closing and recursive calls.</li>
        ...
        <h2 id="16-0-1"   >
          <a href="#16-0-1" class="heading-link"><i class="fas fa-link"></i></a><a href="#16-0-1" class="headerlink" title="16.0.1"></a>16.0.1</h2>
      <ul>
...
<li>Fixed input validation behavior for <code>&lt;input type=&quot;range&quot;&gt;</code> when <code>max=&quot;&quot;</code> is less than <code>min=&quot;&quot;</code>.</li>
        ...
        <h2 id="16-0-0"   >
          <a href="#16-0-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#16-0-0" class="headerlink" title="16.0.0"></a>16.0.0</h2>
      <p>For this release we’d like to welcome <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/jsdom/jsdom/commits?author=pmdartus" >@pmdartus</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span> to the core team. Among other work, he’s driven the heroic effort of constructor prototype and reform in jsdom and its dependencies over the last few months, to allow us to move away from shared constructors and prototypes, and set the groundwork for custom elements support (<span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/jsdom/jsdom/pull/2548" >coming soon</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>!).</p>
...
<li>Each jsdom <code>Window</code> now creates new instances of all the web platform globals. That is, our old <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/jsdom/jsdom/blob/35894a6703ed1f4de98942780bd99244ac27f600/README.md#shared-constructors-and-prototypes" >shared constructor and prototypes</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span> caveat is no longer in play.</li>
...
<li>Improved the performance of <code>getComputedStyle()</code>. (eps1lon)</li>
        ...
        <h2 id="15-2-1"   >
          <a href="#15-2-1" class="heading-link"><i class="fas fa-link"></i></a><a href="#15-2-1" class="headerlink" title="15.2.1"></a>15.2.1</h2>
      <ul>
...
<li>Upgraded <code>nwsapi</code> minimum version to 2.2.0, which fixes issues with <code>::-webkit-</code> prefixed pseudo-elements and namespaced attribute selectors.</li>
        ...
        <h2 id="15-2-0"   >
          <a href="#15-2-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#15-2-0" class="headerlink" title="15.2.0"></a>15.2.0</h2>
      <ul>
...
<li>Set <code>canvas</code> as an optional &#96;&#96;peerDependency&#96;, which apparently helps with Yarn PnP support.</li>
        ...
        <h2 id="15-1-1"   >
          <a href="#15-1-1" class="heading-link"><i class="fas fa-link"></i></a><a href="#15-1-1" class="headerlink" title="15.1.1"></a>15.1.1</h2>
      <ul>
<li>Moved the <code>nonce</code> property from <code>HTMLScriptElement</code> and <code>HTMLStyleElement</code> to <code>HTMLElement</code>. Note that it is still just a simple reflection of the attribute, and has not been updated for the rest of the changes in <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/whatwg/html/pull/2373" >whatwg&#x2F;html#2373</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>.</li>
...
<li>Fixed <code>XMLHttpRequest</code> reserializing <code>content-type</code> request headers unnecessarily. See <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/whatwg/mimesniff/issues/84" >whatwg&#x2F;mimesniff#84</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span> for more details. (thiagohirata)</li>
<li>Fixed <code>element.tagName</code> to be the ASCII uppercase of the element’s qualified name, instead of the Unicode uppercase.</li>
        ...
        <h2 id="15-1-0"   >
          <a href="#15-1-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#15-1-0" class="headerlink" title="15.1.0"></a>15.1.0</h2>
      <ul>
...
<li>Fixed event path iteration in shadow DOM cases, following spec fixes at <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/whatwg/dom/pull/686" >whatwg&#x2F;dom#686</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span> and <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/whatwg/dom/pull/750" >whatwg&#x2F;dom#750</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>.</li>
<li>Fixed <code>pattern=&quot;&quot;</code> form control validation to apply the given regular expression to the whole string. (kontomondo)</li>
        ...
        <h2 id="15-0-0"   >
          <a href="#15-0-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#15-0-0" class="headerlink" title="15.0.0"></a>15.0.0</h2>
...
<li>When using the <code>Blob</code> or <code>File</code> constructor with the <code>endings: &quot;native&quot;</code> option, jsdom will now convert line endings to <code>\n</code> on all operating systems, for consistency. Previously, on Windows, it would convert line endings to <code>\r\n</code>.</li>
        ...
        <h2 id="14-1-0"   >
          <a href="#14-1-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#14-1-0" class="headerlink" title="14.1.0"></a>14.1.0</h2>
      <ul>
...
<li>Updated the minimum <a target="_blank" rel="noopener" href="https://www.npmjs.com/package/nwsapi"><code>nwsapi</code></a> version from v2.1.1 to v2.1.3, bringing along a few fixes in our selector engine.</li>
</ul>

        <h2 id="14-0-0"   >
          <a href="#14-0-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#14-0-0" class="headerlink" title="14.0.0"></a>14.0.0</h2>
      <p>Breaking changes:</p>
<ul>
<li><code>JSDOM.fragment()</code> now creates fragments whose document has no <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://html.spec.whatwg.org/multipage/#concept-document-bc" >browsing context</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>, i.e. no associated <code>Window</code>. This means the <code>defaultView</code> property will be null, resources will not load, etc.</li>
...
<li>Fixed <code>&lt;template&gt;</code> elements to have the correct semantics, of using a separate browsing-context-less document to store its contents. In particular this means resources will not be fetched for elements inside the <code>&lt;template&gt;</code>, as per spec.</li>
        ...
        <h2 id="13-2-0"   >
          <a href="#13-2-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#13-2-0" class="headerlink" title="13.2.0"></a>13.2.0</h2>
      <ul>
...
<li>Upgraded our <a target="_blank" rel="noopener" href="https://github.com/lddubeau/saxes"><code>saxes</code></a> dependency, so that it now correctly errors on XML fragments like <code>&lt;foo bar:=&quot;1&quot;/&gt;</code>.</li>
</ul>

        <h2 id="13-1-0"   >
          <a href="#13-1-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#13-1-0" class="headerlink" title="13.1.0"></a>13.1.0</h2>
      <ul>
...
<li>Fixed the performance of parsing large text nodes, particularly noticeable for large inline <code>&lt;style&gt;</code> or <code>&lt;script&gt;</code> elements. This regressed in v11.6.0. To learn more, see <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://bugs.chromium.org/p/v8/issues/detail?id=6730#c4" >V8 issue #6730</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>.</li>
...
<li>Fixed radio button group name matching to be case-sensitive, per <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/whatwg/html/commit/6acdb2122298d2bb7bb839c0a61b4e1f9b0f9bc9" >a spec update</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>.</li>
...
<li>Fixed the value of <code>Element.prototype[Symbol.unscopables]</code>.</li>
        ...
        <h2 id="13-0-0"   >
          <a href="#13-0-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#13-0-0" class="headerlink" title="13.0.0"></a>13.0.0</h2>
      <p>Breaking change:</p>
<ul>
<li>Removed support for v1.x of the <a target="_blank" rel="noopener" href="https://github.com/Automattic/node-canvas"><code>canvas</code></a> package, in favor of v2.x. This also removes support for <code>canvas-prebuilt</code>, since <code>canvas</code> v2.x has a built-in prebuilt version.</li>
</ul>
<p>Other changes:</p>
<ul>
<li>Added proper XML serialization, based on the <a target="_blank" rel="noopener" href="https://github.com/jsdom/w3c-xmlserializer"><code>w3c-xmlserializer</code></a> package. Previously we were just using the HTML serialization, even in XML documents.</li>
...
<li>Fixed our implementation of the node tree modification constraints (for example the <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://dom.spec.whatwg.org/#concept-node-ensure-pre-insertion-validity" >ensure pre-insertion validity</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span> algorithm). It is no longer possible to add, remove, or move nodes to create impossible DOM trees. (pmdartus)</li>
</ul>

        <h2 id="12-2-0"   >
          <a href="#12-2-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#12-2-0" class="headerlink" title="12.2.0"></a>12.2.0</h2>
      <ul>
...
<li>Stopped swallowing errors when the <code>canvas</code> or <code>canvas-prebuilt</code> packages were installed, but failed to load. (joscha)</li>
        ...
        <h2 id="12-1-0"   >
          <a href="#12-1-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#12-1-0" class="headerlink" title="12.1.0"></a>12.1.0</h2>
      <ul>
<li>Dramatically upgraded our XML parser, from the unmaintained <a target="_blank" rel="noopener" href="https://github.com/isaacs/sax-js"><code>sax</code></a> package to the well-maintained <a target="_blank" rel="noopener" href="https://github.com/lddubeau/saxes"><code>saxes</code></a> replacement. This increases our specification conformance, including rejecting certain ill-formed XML documents that were previously accepted, and properly handling other constructs like empty comments, CDATA sections, and <code>&lt;script&gt;</code> elements. (lddubeau)</li>
...
<li>“Fixed” <code>&lt;script&gt;</code>s with the <code>async</code> attribute to not execute before sync <code>&lt;script&gt;</code>s that precede them. We still do not, in general, have proper execution of scripts during the initial parsing of a document, so this fix is more of a reduction of badness than an alignment with the specification. This behavior regressed in v12.0.0. (sarvaje)</li>
        ...
        <h2 id="12-0-0"   >
          <a href="#12-0-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#12-0-0" class="headerlink" title="12.0.0"></a>12.0.0</h2>
      <p>This major release brings along our <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/jsdom/jsdom#loading-subresources" >new resource loader API</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>, finally bringing all the capabilities from jsdom v9 to the new (jsdom v10+) API. Thanks very much to <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/sarvaje" >@sarvaje</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span> for his work to make this possible!</p>
<p>Breaking changes:</p>
<ul>
<li>jsdom now requires Node.js v8.</li>
<li>Removed the old jsdom API, as the new API now has all the capabilities you need.</li>
<li>Updated our <a target="_blank" rel="noopener" href="https://github.com/inikulin/parse5/"><code>parse5</code></a> dependency to v5, which changes the format of the node locations returned by <code>dom.nodeLocation()</code>.</li>
<li>Updated our <a target="_blank" rel="noopener" href="https://github.com/jsdom/whatwg-url"><code>whatwg-url</code></a> dependency to v7, which changes the origin of <code>file:</code> URLs to be an opaque origin (and thus <code>file:</code> URLs are no longer same origin to each other).</li>
</ul>
<p>Other changes:</p>
<ul>
...
<li>Fixed the default User-Agent to say “unknown OS” instead of “undefined” when jsdom is used in web browsers.</li>
        ...
        <h2 id="11-12-0"   >
          <a href="#11-12-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#11-12-0" class="headerlink" title="11.12.0"></a>11.12.0</h2>
      <ul>
...
<li>Upgraded <code>nwsapi</code> to v2.0.7, bringing along various fixes to our selector engine.</li>
        ...
        <h2 id="11-11-0"   >
          <a href="#11-11-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#11-11-0" class="headerlink" title="11.11.0"></a>11.11.0</h2>
      <ul>
...
<li>Upgraded our selector matching engine from <code>nwsmatcher</code> to <code>nwsapi</code>, bringing along extensive fixes, performance improvements, and additional selector support.</li>
        ...
        <h2 id="11-10-0"   >
          <a href="#11-10-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#11-10-0" class="headerlink" title="11.10.0"></a>11.10.0</h2>
      <ul>
...
<li>Fixed <code>XMLHttpRequest</code> to correctly set the User-Agent header, and set it on CORS preflight requests. (BehindTheMath)</li>
        ...
        <h2 id="11-9-0"   >
          <a href="#11-9-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#11-9-0" class="headerlink" title="11.9.0"></a>11.9.0</h2>
      <ul>
...
<li>Fixed <code>canvas.toBlob()</code> to properly pass through the JPEG quality argument, instead of always passing zero to <code>node-canvas</code>. (challakoushik)</li>
        ...
        <h2 id="11-8-0"   >
          <a href="#11-8-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#11-8-0" class="headerlink" title="11.8.0"></a>11.8.0</h2>
      <ul>
...
<li>Added <code>getElementById()</code> to <code>DocumentFragment</code>.</li>
        ...
        <h2 id="11-7-0"   >
          <a href="#11-7-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#11-7-0" class="headerlink" title="11.7.0"></a>11.7.0</h2>
      <ul>
...
<li>Improved MIME type and <code>data:</code> URL parsing throughout jsdom, by using the new <a target="_blank" rel="noopener" href="https://www.npmjs.com/package/whatwg-mimetype"><code>whatwg-mimetype</code></a> and <a target="_blank" rel="noopener" href="https://www.npmjs.com/package/data-urls"><code>data-urls</code></a> packages.</li>
<li>Removed some unnecessary <code>.webidl</code> files that were included in the npm package.</li>
</ul>

        <h2 id="11-6-2"   >
          <a href="#11-6-2" class="heading-link"><i class="fas fa-link"></i></a><a href="#11-6-2" class="headerlink" title="11.6.2"></a>11.6.2</h2>
      <ul>
...
<li>Generally improved the spec-conformance of when <code>&lt;style&gt;</code> and <code>&lt;script&gt;</code> elements are evaluated; for example, <code>&lt;script&gt;</code> elements inserted by <code>innerHTML</code> are no longer evaluated.</li>
        ...
        <h2 id="11-6-1"   >
          <a href="#11-6-1" class="heading-link"><i class="fas fa-link"></i></a><a href="#11-6-1" class="headerlink" title="11.6.1"></a>11.6.1</h2>
      <ul>
...
<p>Another regression remains where we are emitting spurious CSS-parsing <code>jsdomError</code> events; see <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/jsdom/jsdom/issues/2123" >#2123</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>. We also discovered a large amount of preexisting brokenness around <code>&lt;style&gt;</code>, <code>&lt;link&gt;</code>, and <code>@import</code>; see <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/jsdom/jsdom/issues/2124" >#2124</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span> for more details.</p>
<p>We’ll try to fix these soon, especially the regression.</p>

        <h2 id="11-6-0"   >
          <a href="#11-6-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#11-6-0" class="headerlink" title="11.6.0"></a>11.6.0</h2>
      <ul>
<li>Added a fully-functioning <code>WebSocket</code> implementation!</li>
<li>Added a <code>window.performance</code> implementation, including the basics of the <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://w3c.github.io/hr-time/" >High Resolution Time</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span> specification: <code>performance.now()</code>, <code>performance.timeOrigin</code>, and <code>performance.toJSON()</code>.</li>
...
<li>Fixed all URL-accepting properties to properly perform <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://infra.spec.whatwg.org/#javascript-string-convert" >scalar value string conversion</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span> and URL resolution.</li>
<li>Fixed many other small edge-case conformance issues in the API surface of various web APIs; see <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/jsdom/jsdom/pull/2053" >#2053</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span> and <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/jsdom/jsdom/pull/2081" >#2081</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span> for more information.</li>
...
<li>Removed the nonstandard <code>window.scrollLeft</code> and <code>window.scrollTop</code> properties, and the <code>window.createPopup()</code> method.</li>
        ...
        <h2 id="11-5-1"   >
          <a href="#11-5-1" class="heading-link"><i class="fas fa-link"></i></a><a href="#11-5-1" class="headerlink" title="11.5.1"></a>11.5.1</h2>
...
<li>Fixed validation for file <code>&lt;input&gt;</code>s and implemented validation for more input types.</li>
        ...
        <h2 id="11-4-0"   >
          <a href="#11-4-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#11-4-0" class="headerlink" title="11.4.0"></a>11.4.0</h2>
      <p>For this release we’d like to welcome <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/jsdom/jsdom/commits?author=Zirro" >@Zirro</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span> to the core team; his contributions over the course of this year have enhanced jsdom immensely.</p>
<ul>
...
<li>Added the new <code>pretendToBeVisual</code> option, which controls the presence of the new <code>requestAnimationFrame()</code> and <code>cancelAnimationFrame()</code> methods, and the new values of <code>document.hidden</code>&#x2F;<code>document.visibilityState</code>. <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/jsdom/jsdom#pretending-to-be-a-visual-browser" >See the README</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span> for more information. (SimenB)</li>
...
<li>Removed the <code>&lt;applet&gt;</code> element, <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/whatwg/html/pull/1399" >following the spec</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>.</li>
</ul>

        <h2 id="11-3-0"   >
          <a href="#11-3-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#11-3-0" class="headerlink" title="11.3.0"></a>11.3.0</h2>
      <p>For this release we’d like to formally welcome <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/jsdom/jsdom/commits?author=TimothyGu" >@TimothyGu</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span> to the core team, as a prolific contributor. He will join the illustrious ranks of those who do so much work on jsdom that we no longer note their names in the changelog.</p>
<ul>
...
<li>Significantly sped up synchronous <code>XMLHttpRequest</code>. (Zirro)</li>
        ...
        <h2 id="11-2-0"   >
          <a href="#11-2-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#11-2-0" class="headerlink" title="11.2.0"></a>11.2.0</h2>
      <p>This release brings with it a much-awaited infrastructure change, as part of <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/jsdom/webidl2js/releases/tag/v7.3.0" >webidl2js v7.3.0</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span> by the ever-amazing TimothyGu: jsdom can now generate spec-compliant versions of classes that have “<code>Proxy</code>-like” behavior, i.e. allow getting or setting keys in unusual ways. This enables a number of improvements, also by TimothyGu:</p>
<ul>
...
<p>This infrastructure will allow us to improve and implement many other similar behaviors; that work is being tracked in <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/jsdom/jsdom/issues/1129" >#1129</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>.</p>
...
<li>Updated the interaction between a <code>&lt;textarea&gt;</code>‘s <code>value</code>, <code>defaultValue</code>, and <code>textContent</code> per <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/whatwg/html/commit/5afbba1cf62ee01bc6af3fd220d01f3f7591a0fc" >a recent spec change</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span></li>
...
<li>Improved edge-case spec compliance of <code>NodeIterator</code>.</li>
        ...
        <h2 id="11-1-0"   >
          <a href="#11-1-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#11-1-0" class="headerlink" title="11.1.0"></a>11.1.0</h2>
      <ul>
...
<li>Fixed timers to not start after a window is <code>close()</code>d, which could cause strange errors since most objects are unusable at that point. (Enverbalalic)</li>
        ...
        <h2 id="11-0-0"   >
          <a href="#11-0-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#11-0-0" class="headerlink" title="11.0.0"></a>11.0.0</h2>
      <p>Breaking changes:</p>
<ul>
<li>Custom parsers, via the <code>parser</code> option to the old API, can no longer be specified. They were never tested, often broken, and a maintenance burden. The defaults, of <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://www.npmjs.com/package/parse5" >parse5</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span> for HTML and <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://www.npmjs.com/package/sax" >sax</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span> for XML, now always apply.</li>
...
<li>Many updates per recent spec changes: (Zirro)<ul>
...
<li>Removed some remaining not-per-spec <code>toString()</code> methods on various prototypes, which were made redundant in v10.1.0 but we forgot to remove.</li>
        ...
        <h2 id="10-1-0"   >
          <a href="#10-1-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#10-1-0" class="headerlink" title="10.1.0"></a>10.1.0</h2>
      <ul>
...
<li>Fixed an uncaught exception that occurred if you called <code>xhr.abort()</code> during a <code>readystatechange</code> event.</li>
        ...
        <h2 id="10-0-0"   >
          <a href="#10-0-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#10-0-0" class="headerlink" title="10.0.0"></a>10.0.0</h2>
...
<li><strong>Changed the <code>omitJsdomErrors</code> option to <code>omitJSDOMErrors</code></strong>, for consistency <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://w3ctag.github.io/design-principles/#casing-rules" >with web platform APIs</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>.</li>
...
<li>Improved the <code>xhr.open()</code> error message when there are not enough arguments. (lencioni)</li>
        ...
        <h2 id="9-12-0"   >
          <a href="#9-12-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#9-12-0" class="headerlink" title="9.12.0"></a>9.12.0</h2>
      <ul>
...
<li>Fixed <code>clearTimeout()</code> and <code>clearInterval()</code> to work correctly when using jsdom browserified.</li>
        ...
        <h2 id="9-11-0"   >
          <a href="#9-11-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#9-11-0" class="headerlink" title="9.11.0"></a>9.11.0</h2>
      <ul>
...
<li>Fixed various edge cases in our type conversions applied to method arguments and setters throughout the web platform APIs implemented by jsdom.</li>
        ...
        <h2 id="9-10-0"   >
          <a href="#9-10-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#9-10-0" class="headerlink" title="9.10.0"></a>9.10.0</h2>
      <ul>
...
<li>Changed <code>navigator.vendor</code> to return <code>&quot;Apple Computer, Inc.&quot;</code> instead of <code>&quot;Google Inc.&quot;</code>, since we have chosen the WebKit <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://html.spec.whatwg.org/multipage/webappapis.html#concept-navigator-compatibility-mode" >navigator compatibility mode</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>.</li>
</ul>

        <h2 id="9-9-1"   >
          <a href="#9-9-1" class="heading-link"><i class="fas fa-link"></i></a><a href="#9-9-1" class="headerlink" title="9.9.1"></a>9.9.1</h2>
      <ul>
<li>Removed the use of <code>array.includes</code> to fix a compatibility issue with Node.js v4.</li>
</ul>

        <h2 id="9-9-0"   >
          <a href="#9-9-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#9-9-0" class="headerlink" title="9.9.0"></a>9.9.0</h2>
      <ul>
...
<li>Fixed <code>HTMLCollection</code> named access to return the first element encountered, not the last.</li>
        ...
        <h2 id="9-8-3"   >
          <a href="#9-8-3" class="heading-link"><i class="fas fa-link"></i></a><a href="#9-8-3" class="headerlink" title="9.8.3"></a>9.8.3</h2>
      <ul>
<li>Fixed syntax errors in Node.js v4.</li>
</ul>

        <h2 id="9-8-2"   >
          <a href="#9-8-2" class="heading-link"><i class="fas fa-link"></i></a><a href="#9-8-2" class="headerlink" title="9.8.2"></a>9.8.2</h2>
      <ul>
<li>Fixed <code>DOMTokenList</code> and <code>getElementsByClassName</code> to only split on ASCII whitespace, not all Unicode whitespace.</li>
        ...
        <h2 id="9-8-1"   >
          <a href="#9-8-1" class="heading-link"><i class="fas fa-link"></i></a><a href="#9-8-1" class="headerlink" title="9.8.1"></a>9.8.1</h2>
      <ul>
<li>Fixed an error that occurred when passing no class names to <code>getElementsByClassName</code>, e.g. <code>getElementsByClassName(&quot;&quot;)</code> or <code>getElementsByClassName(&quot; &quot;)</code>.</li>
        ...
        <h2 id="9-8-0"   >
          <a href="#9-8-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#9-8-0" class="headerlink" title="9.8.0"></a>9.8.0</h2>
      <ul>
...
<li>Fixed a minor edge-case regression where non-HTML elements with the name <code>&quot;iframe&quot;</code> became focusable in v9.7.0.</li>
        ...
        <h2 id="9-7-1"   >
          <a href="#9-7-1" class="heading-link"><i class="fas fa-link"></i></a><a href="#9-7-1" class="headerlink" title="9.7.1"></a>9.7.1</h2>
      <ul>
<li>Fixed a performance regression introduced in 9.5.0 for modifying the DOM. It was particularly noticable during initial parsing of a document with many elements; for example, one test showed parsing ten thousand elements taking 36.4 seconds, whereas after this fix it is back to a more reasonable 0.4 seconds.</li>
        ...
        <h2 id="9-7-0"   >
          <a href="#9-7-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#9-7-0" class="headerlink" title="9.7.0"></a>9.7.0</h2>
      <ul>
...
<li>Fixed the focus management to ensure that focusing something inside an <code>iframe</code> will also focus the <code>iframe</code> itself. (acusti)</li>
        ...
        <h2 id="9-6-0"   >
          <a href="#9-6-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#9-6-0" class="headerlink" title="9.6.0"></a>9.6.0</h2>
      <ul>
...
<li>Tweaked the behavior of calling <code>event.stopPropagation</code> and <code>event.stopImmediatePropagation</code> on already-dispatched events, per <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/whatwg/dom/commit/806d4aab584f6fc38c21f8e088b51b8ba3e27e20" >the latest changes to the DOM Standard</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>.</li>
</ul>

        <h2 id="9-5-0"   >
          <a href="#9-5-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#9-5-0" class="headerlink" title="9.5.0"></a>9.5.0</h2>
      <ul>
...
<li>Fixed <code>console.groupCollapse</code> to be <code>console.groupCollapsed</code> (and changed the virtual console accordingly).</li>
        ...
        <h2 id="9-4-5"   >
          <a href="#9-4-5" class="heading-link"><i class="fas fa-link"></i></a><a href="#9-4-5" class="headerlink" title="9.4.5"></a>9.4.5</h2>
      <ul>
<li>Fixed <code>error</code> events from failed resource loads going missing since v9.4.3. I really should have tested that release better.</li>
        ...
        <h2 id="9-4-4"   >
          <a href="#9-4-4" class="heading-link"><i class="fas fa-link"></i></a><a href="#9-4-4" class="headerlink" title="9.4.4"></a>9.4.4</h2>
      <ul>
<li>Fixed a leftover <code>console.log</code> introduced in the error handling path in v9.4.3.</li>
</ul>

        <h2 id="9-4-3"   >
          <a href="#9-4-3" class="heading-link"><i class="fas fa-link"></i></a><a href="#9-4-3" class="headerlink" title="9.4.3"></a>9.4.3</h2>
      <ul>
<li>Fixed spurious <code>&quot;jsdomError&quot;</code>s occuring when closing a window, due to aborted resource loads.</li>
</ul>

        <h2 id="9-4-2"   >
          <a href="#9-4-2" class="heading-link"><i class="fas fa-link"></i></a><a href="#9-4-2" class="headerlink" title="9.4.2"></a>9.4.2</h2>
      <ul>
...
<li>Upgraded the minimum tough-cookie version to ensure all installations are protected against <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://nodesecurity.io/advisories/130" >a security advisory</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>.</li>
</ul>

        <h2 id="9-4-1"   >
          <a href="#9-4-1" class="heading-link"><i class="fas fa-link"></i></a><a href="#9-4-1" class="headerlink" title="9.4.1"></a>9.4.1</h2>
      <ul>
<li>Implemented the cloning steps for <code>&lt;input&gt;</code> elements, so that cloned inputs properly copy over their value, checkedness, dirty value flag, and dirty checkedness flag. (matthewp)</li>
        ...
        <h2 id="9-4-0"   >
          <a href="#9-4-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#9-4-0" class="headerlink" title="9.4.0"></a>9.4.0</h2>
      <ul>
...
<li>Updated <code>FormData</code> for <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/whatwg/xhr/commit/1a75845e67792418a7721d516266ad01a90f2062" >recent spec fixes</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>: blobs, files, and filenames should now all work like you’d expect.</li>
<li>Updated the <code>FormData</code> constructor to use the proper, rather-complex, <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://html.spec.whatwg.org/multipage/forms.html#constructing-form-data-set" >constructing the form data set</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span> algorithm.</li>
...
<li>Fixed the window object’s named properties to correctly return the <code>&lt;iframe&gt;</code> element or the <code>&lt;iframe&gt;</code>‘s window in appropriate scenarios involving <code>name</code> vs. <code>id</code> attributes on the <code>&lt;iframe&gt;</code>. (matthewp)</li>
        ...
        <h2 id="9-3-0"   >
          <a href="#9-3-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#9-3-0" class="headerlink" title="9.3.0"></a>9.3.0</h2>
      <ul>
...
<li>Fixed unhandled errors thrown in XHR event handlers being swallowed; they now properly are redirected to the virtual console.</li>
        ...
        <h2 id="9-2-1"   >
          <a href="#9-2-1" class="heading-link"><i class="fas fa-link"></i></a><a href="#9-2-1" class="headerlink" title="9.2.1"></a>9.2.1</h2>
      <ul>
<li>Fixed <code>&lt;input&gt;</code>‘s <code>selectionStart</code>, <code>selectionEnd</code>, and <code>selectionDirection</code> getters to return null, instead of throwing, for elements that do not allow selection, per <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/whatwg/html/pull/1006" >a recent spec change</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>.</li>
<li>Fixed <code>&lt;base&gt;</code>‘s <code>href</code> getter logic to return the attribute value instead of the empty string for unparseable URLs, per <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/whatwg/html/pull/1064" >a recent spec change</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>.</li>
...
<li>Updated <code>cssstyle</code> minimum version to ensure all jsdom installs (not just fresh ones) get the benefit of <code>cssstyle</code>‘s recently-better <code>background</code> and <code>width</code> setters.</li>
        ...
        <h2 id="9-2-0"   >
          <a href="#9-2-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#9-2-0" class="headerlink" title="9.2.0"></a>9.2.0</h2>
      <ul>
...
<li>Fixed <code>XMLHttpRequest</code> response header filtering for cross-origin requests; this also fixes <code>ProgressEvent</code>s fired from such XHRs. (nicolashenry)</li>
        ...
        <h2 id="9-1-0"   >
          <a href="#9-1-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#9-1-0" class="headerlink" title="9.1.0"></a>9.1.0</h2>
      <ul>
<li>Added a somewhat-reasonable implementation of focus and focus events. Although the full complexity of focus is not implemented, the following improvements have been made:<ul>
...
<li>Reimplemented <code>navigator</code> to be to-spec:<ul>
...
<li>Fixed a regression introduced in v9.0.0 where invalid CSS would cause a crash while attempting to parse it. Instead, a <code>&quot;jsdomError&quot;</code> will now be emitted to the virtual console.</li>
        ...
        <h2 id="9-0-0"   >
          <a href="#9-0-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#9-0-0" class="headerlink" title="9.0.0"></a>9.0.0</h2>
...
<p>However, recent performance investigations revealed that mutation events were the major bottleneck in most jsdom operations; tools like <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/bterlson/ecmarkup" >ecmarkup</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span> which make heavy use of jsdom had their running time halved by removing mutation events, which add serious overhead to every DOM mutation. As such, we are doing a major release with them removed, so that jsdom users can benefit from this massive performance gain.</p>
<p>Mutation observer support is <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/jsdom/jsdom/issues/639" >in progress</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>; please use the GitHub reactions feature to vote on that issue if you are impacted by this removal and are hoping for mutation observer support to replace it.</p>
...
<li>Made various improvements to XMLHttpRequest (nicolashenry):<ul>
...
<li>Fixed the <code>Blob</code> constructor’s <code>type</code> validation. (nicolashenry)</li>
        ...
        <h2 id="8-5-0"   >
          <a href="#8-5-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#8-5-0" class="headerlink" title="8.5.0"></a>8.5.0</h2>
      <ul>
<li>Added encoding handling (nicolashenry)<ul>
...
<li>Fixed setting proxied inline event handlers, such as <code>doc.body</code>‘s <code>onload=&quot;&quot;</code> attribute, for documents that do not have a browsing context.</li>
        ...
        <h2 id="8-4-1"   >
          <a href="#8-4-1" class="heading-link"><i class="fas fa-link"></i></a><a href="#8-4-1" class="headerlink" title="8.4.1"></a>8.4.1</h2>
      <ul>
<li>Fixed an issue where setting <code>selected</code> on an multi-select would clear all other selectedness.</li>
</ul>

        <h2 id="8-4-0"   >
          <a href="#8-4-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#8-4-0" class="headerlink" title="8.4.0"></a>8.4.0</h2>
      <ul>
...
<li>Fixed a few issues with generated files in the published package, which seem to have impacted webpack users.</li>
        ...
        <h2 id="8-3-1"   >
          <a href="#8-3-1" class="heading-link"><i class="fas fa-link"></i></a><a href="#8-3-1" class="headerlink" title="8.3.1"></a>8.3.1</h2>
      <ul>
<li>Fixed an issue where if you modified <code>Object.prototype</code>, spurious attributes would show up on your jsdom nodes. (deckar01)</li>
        ...
        <h2 id="8-3-0"   >
          <a href="#8-3-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#8-3-0" class="headerlink" title="8.3.0"></a>8.3.0</h2>
      <ul>
<li>Added image loading and decoding, when the <code>canvas</code> npm package is installed (lehni). In practice, this means that if you enable fetching <code>&quot;img&quot;</code> external resources, then:<ul>
...
<li>Added a basic implementation of the <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://w3c.github.io/page-visibility/" >Page Visibility API</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>, in particular a <code>document.hidden</code> property that always returns <code>true</code>, and a <code>document.visibilityState</code> property that always returns <code>&quot;prerender&quot;</code>. This is a more standard alternative to our proprietary <code>navigator.noUI</code>, which will be removed whenever we release v9.0.0. (kapouer)</li>
</ul>

        <h2 id="8-2-0"   >
          <a href="#8-2-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#8-2-0" class="headerlink" title="8.2.0"></a>8.2.0</h2>
      <ul>
<li>Added correct click behavior for inputs (jeffcarp):<ul>
...
<li>Fixed script execution to check against the canonical list of JavaScript MIME types and only execute those scripts as JavaScript.</li>
        ...
        <h2 id="8-1-1"   >
          <a href="#8-1-1" class="heading-link"><i class="fas fa-link"></i></a><a href="#8-1-1" class="headerlink" title="8.1.1"></a>8.1.1</h2>
      <ul>
<li>Fixed input selection methods and properties to properly differentiate between inputs that can be selected outright vs. textual inputs which allow variable-length selection. (yaycmyk)</li>
        ...
        <h2 id="8-1-0"   >
          <a href="#8-1-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#8-1-0" class="headerlink" title="8.1.0"></a>8.1.0</h2>
      <ul>
<li>Added <code>attr.nodeName</code>, which was <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/whatwg/dom/issues/171" >recently re-added to the spec</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>.</li>
...
<li>Updated our attributes implementation in a few ways for recent spec changes and to fix discovered bugs:<ul>
<li>Added <code>element.getAttributeNames()</code>. (<span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/whatwg/dom/issues/115" >spec addition</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>)</li>
<li><code>setAttributeNode</code> and <code>setAttributeNodeNS</code> can now replace an attribute node, instead of removing the old one and adding a new one; this avoids changing the order in the attribute list. (<span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/whatwg/dom/issues/116" >spec change</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>)</li>
<li><code>NamedNodeMap</code> named properties are now lowercase (except in edge cases involving XML documents or non-HTML elements). (<span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/whatwg/dom/issues/141" >spec change</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>)</li>
...
<li>Updated <code>DOMTokenList</code> to have a <code>value</code> property per <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/whatwg/dom/issues/119" >recent spec changes</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>; its <code>toString</code> serialization also changed slightly.</li>
...
<li>Removed the <code>&quot;keyevents&quot;</code> alias for <code>&quot;keyboardevent&quot;</code> when using <code>document.createEvent</code>, <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/whatwg/dom/issues/148" >per recent spec changes</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>.</li>
</ul>

        <h2 id="8-0-4"   >
          <a href="#8-0-4" class="heading-link"><i class="fas fa-link"></i></a><a href="#8-0-4" class="headerlink" title="8.0.4"></a>8.0.4</h2>
      <ul>
<li>Fixed the <code>this</code> value when you pass a <code>&#123; handleEvent() &#123; ... &#125; &#125;</code> object to <code>addEventListener</code>. (thetalecrafter)</li>
        ...
        <h2 id="8-0-3"   >
          <a href="#8-0-3" class="heading-link"><i class="fas fa-link"></i></a><a href="#8-0-3" class="headerlink" title="8.0.3"></a>8.0.3</h2>
      <ul>
...
<li>Updated <code>cssstyle</code> minimum version to ensure all jsdom installs (not just fresh ones) get the benefit of <code>cssstyle</code>‘s recently-better <code>padding</code> and <code>margin</code> parsing&#x2F;CSSOM.</li>
        ...
        <h2 id="8-0-2"   >
          <a href="#8-0-2" class="heading-link"><i class="fas fa-link"></i></a><a href="#8-0-2" class="headerlink" title="8.0.2"></a>8.0.2</h2>
      <ul>
...
<li>Improved our <code>document.activeElement</code> implementation to be a bit smarter; we still don’t have full focus&#x2F;blur&#x2F;active element semantics, but at least now it falls back to the <code>&lt;body&gt;</code> element when the active element is removed from the document or when no element has been focused yet.</li>
        ...
        <h2 id="8-0-1"   >
          <a href="#8-0-1" class="heading-link"><i class="fas fa-link"></i></a><a href="#8-0-1" class="headerlink" title="8.0.1"></a>8.0.1</h2>
      <ul>
<li>Fixed an issue where the <code>this</code> inside event handler callbacks was not equal to the event’s current target. (Surprisingly there were no tests for this!)</li>
        ...
        <h2 id="8-0-0"   >
          <a href="#8-0-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#8-0-0" class="headerlink" title="8.0.0"></a>8.0.0</h2>
...
<ul>
<li>Reimplemented <code>Location</code>, <code>History</code>, and <code>HTMLHyperlinkElementUtils</code> (used by both <code>HTMLAnchorElement</code> and <code>HTMLAreaElement</code>) according to the latest specs, and using the latest <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/jsdom/whatwg-url" >whatwg-url</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span> package. This greatly improves our correctness on URL resolution and navigation (to the extent we support navigation, i.e. <code>pushState</code> and changing the hash). It should also improve parsing speed as we no longer parse and resolve URLs during parsing.</li>
...
<li>Removed <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="http://www.w3.org/TR/2003/CR-DOM-Level-3-LS-20031107/load-save.html" >“DOM Load and Save”</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span> stub implementation. That spec was never implemented in browsers, and jsdom only contained stubs.</li>
<li>Removed other minor unimplemented, stub, or no-longer-standard APIs from “DOM Level 3”, like the user-data API, <code>DOMError</code>, <code>DOMConfiguration</code>, and <code>DOMStringList</code>.</li>
        ...
        <h2 id="7-2-2"   >
          <a href="#7-2-2" class="heading-link"><i class="fas fa-link"></i></a><a href="#7-2-2" class="headerlink" title="7.2.2"></a>7.2.2</h2>
      <ul>
...
<li>Fixed <code>data:</code> URL parsing to allow empty contents, e.g. <code>data:text/css;base64,</code>. (sebmck)</li>
        ...
        <h2 id="7-2-1"   >
          <a href="#7-2-1" class="heading-link"><i class="fas fa-link"></i></a><a href="#7-2-1" class="headerlink" title="7.2.1"></a>7.2.1</h2>
      <ul>
<li>Fixed a regression in XML parsing of attributes with a namespace URL but no prefix (e.g. <code>&lt;math xmlns=&quot;http://www.w3.org/1998/Math/MathML&quot;&gt;</code>).</li>
        ...
        <h2 id="7-2-0"   >
          <a href="#7-2-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#7-2-0" class="headerlink" title="7.2.0"></a>7.2.0</h2>
      <ul>
<li>Added support for text selection APIs on <code>&lt;input&gt;</code> and <code>&lt;textarea&gt;</code>! (sjelin and yaycmyk)</li>
<li>Replaced our default XML parser with <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://www.npmjs.com/package/sax" >sax</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>, thus fixing many (but not all) issues with XML and XHTML parsing. To get a flavor of the issues fixed, check out these now-closed bugs: <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/jsdom/jsdom/issues/393" >#393</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>, <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/jsdom/jsdom/issues/651" >#651</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>, <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/jsdom/jsdom/issues/415" >#415</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>, <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/jsdom/jsdom/issues/1276" >#1276</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>.</li>
...
<li>Made the task posted by <code>postMessage</code> use the inside-jsdom timer queue, instead of the Node.js one. This allows easier mocking. (cpojer)</li>
        ...
        <h2 id="7-1-1"   >
          <a href="#7-1-1" class="heading-link"><i class="fas fa-link"></i></a><a href="#7-1-1" class="headerlink" title="7.1.1"></a>7.1.1</h2>
      <ul>
...
<li>Fixed <code>FileList</code> objects to no longer have a property named <code>&quot;undefined&quot;</code>. (jfremy)</li>
        ...
        <h2 id="7-1-0"   >
          <a href="#7-1-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#7-1-0" class="headerlink" title="7.1.0"></a>7.1.0</h2>
...
<li>Our <code>Event</code> class hierarchy has been rewritten and fleshed out, fixing many gaps in functionality.<ul>
...
<li>The browser builds now have regained the ability to fetch URLs for content and the like; this had been broken due to an issue with the browser-request package, which is no longer necessary anyway.</li>
        ...
        <h2 id="7-0-2"   >
          <a href="#7-0-2" class="heading-link"><i class="fas fa-link"></i></a><a href="#7-0-2" class="headerlink" title="7.0.2"></a>7.0.2</h2>
      <ul>
<li>Fixed an issue where inside jsdom <code>&lt;script&gt;</code> code, <code>/regexpliteral/ instanceof RegExp</code> would be <code>false</code>.</li>
        ...
        <h2 id="7-0-1"   >
          <a href="#7-0-1" class="heading-link"><i class="fas fa-link"></i></a><a href="#7-0-1" class="headerlink" title="7.0.1"></a>7.0.1</h2>
      <ul>
<li>Fixed two bugs with <code>Node.prototype.isEqualNode</code>:<ul>
...
<li>Enforced that <code>document.implementation.createDocumentType</code> requires all three of its arguments.</li>
        ...
        <h2 id="7-0-0"   >
          <a href="#7-0-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#7-0-0" class="headerlink" title="7.0.0"></a>7.0.0</h2>
      <p>This major release has as its headlining feature a completely re-written <code>XMLHttpRequest</code> implementation, in a heroic effort by <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/nicolashenry" >@nicolashenry</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>. It includes a number of other smaller improvements and fixes. The breaking changes are highlighted in bold below.</p>
<ul>
<li><strong>Node.js 4.0 onward is now required</strong>, as we have begun using ES2015 features only present there.</li>
<li>Completely re-implemented <code>XMLHttpRequest</code> and related classes (nicolashenry):<ul>
...
<li><strong>The <code>&#123; omitJsdomErrors &#125;</code> option of the virtual console has moved</strong>; it is no longer provided when creating the virtual console, but instead when calling <code>sendTo</code>.</li>
        ...
        <h2 id="6-5-1"   >
          <a href="#6-5-1" class="heading-link"><i class="fas fa-link"></i></a><a href="#6-5-1" class="headerlink" title="6.5.1"></a>6.5.1</h2>
      <ul>
<li>Fixed an issue where with <code>jsdom.jsdom</code>, you had to pass <code>referrer</code> and <code>cookie</code> options as top-level, whereas with <code>jsdom.env</code>, you had to nest them under a <code>document</code> option. This was unnecessarily confusing. Now both possibilities are allowed for both functions. (The readme only documents the top-level version, though.)</li>
        ...
        <h2 id="6-5-0"   >
          <a href="#6-5-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#6-5-0" class="headerlink" title="6.5.0"></a>6.5.0</h2>
      <ul>
<li>Added <code>NodeList.prototype[Symbol.iterator]</code>, so you can now use <code>for</code>-<code>of</code> loops with <code>NodeList</code>s.</li>
        ...
        <h2 id="6-4-0"   >
          <a href="#6-4-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#6-4-0" class="headerlink" title="6.4.0"></a>6.4.0</h2>
      <ul>
...
<li>Updated <code>NodeList</code> and <code>HTMLCollection</code> to match the spec. The most noticable change is that <code>HTMLCollection</code> no longer inherits from <code>NodeList</code>.</li>
        ...
        <h2 id="6-3-0"   >
          <a href="#6-3-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#6-3-0" class="headerlink" title="6.3.0"></a>6.3.0</h2>
      <ul>
<li>Added a fully spec-compliant implementation of <code>window.atob</code> and <code>window.btoa</code>. (jeffcarp)</li>
<li>Fixed many issues with our <code>&lt;canvas&gt;</code> implementation:<ul>
...
<li>Introduced and upated many of our element classes, so that at least every tag name&#x2F;element class pair is now correct, even if some of the classes are stubs. In particular:<ul>
...
<li>Updated everything having to do with base URLs to be per-spec:<ul>
...
<li>When you provide a <code>url: ...</code> option to <code>jsdom.jsdom()</code> or <code>jsdom.env()</code>, the given string is now attempted to be resolved as a URL before it is installed as <code>document.URL</code>.<ul>
...
<li>In a future major release, we will start throwing if strings that cannot be parsed as valid absolute URL are provided for this option.</li>
        ...
        <h2 id="6-2-0"   >
          <a href="#6-2-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#6-2-0" class="headerlink" title="6.2.0"></a>6.2.0</h2>
      <ul>
...
<li>Fixed the <code>DOMSubtreeModified</code> event to fire in more cases. Note that our mutation events implementation remains incomplete, and will eventually be removed (in a major release) once we implement mutation observers. (selam)</li>
        ...
        <h2 id="6-1-0"   >
          <a href="#6-1-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#6-1-0" class="headerlink" title="6.1.0"></a>6.1.0</h2>
      <ul>
<li>Added basic implementations of <code>HTMLMediaElement</code> and <code>HTMLVideoElement</code>, back-ported from Facebook’s Jest project. (cpojer)</li>
        ...
        <h2 id="6-0-1"   >
          <a href="#6-0-1" class="heading-link"><i class="fas fa-link"></i></a><a href="#6-0-1" class="headerlink" title="6.0.1"></a>6.0.1</h2>
      <ul>
...
<li>Fixed <code>XMLHttpRequest.prototype.response</code> to correctly return the response text even when <code>responseType</code> was unset. (justinmchase)</li>
        ...
        <h2 id="6-0-0"   >
          <a href="#6-0-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#6-0-0" class="headerlink" title="6.0.0"></a>6.0.0</h2>
...
<p>This release also welcomes <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/jsdom/jsdom/commits/master?author=Joris-van-der-Wel" >long-time contributer</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span> <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/Joris-van-der-Wel/" >@Joris-van-der-Wel</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span> to the core team. You may recognize him from earlier changelogs. We’re very happy to have his help in making jsdom awesome!</p>
<ul>
<li><strong>io.js 2.0 onward is now required</strong>, as we have begun using ES2015 features only present there.</li>
<li>Improved performance dramatically, by ~10000x in some cases, due to the following changes:<ul>
...
<li>Overhauled everything dealing with tree traversal to use a new library, <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/jsdom/js-symbol-tree" >symbol-tree</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>, to turn many operations that were previously O(n^2) or O(n) into O(n) or O(1).</li>
...
<li>Overhauled how error handling works in jsdom:<ul>
...
<li>The virtual console is now the destination for several types of errors from jsdom, using <a target="_blank" rel="noopener" href="https://github.com/jsdom/jsdom#virtual-console-jsdomerror-error-reporting">the new event <code>&quot;jsdomError&quot;</code></a>. This includes: errors loading external resources; script execution errors unhandled by <code>window.onerror</code>; and not-implemented warnings resulting from calling methods like <code>window.alert</code> which jsdom explicitly does not support.</li>
<li>Since script errors are now handled by <code>window.onerror</code> and the virtual console, they are no longer included in the initialization process. This results in two changes to <code>jsdom.env</code> and the initialization lifecycle:<ul>
...
<li>URL parsing and resolution was entirely overhauled to follow <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="http://url.spec.whatwg.org/" >the URL standard</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>!<ul>
...
<li>The new <a target="_blank" rel="noopener" href="https://url.spec.whatwg.org/#url"><code>URL</code> class</a> has been added to <code>window</code></li>
<li>The interfaces for <code>HTMLAnchorElement.prototype</code> and <code>document.location</code> (as well as <code>URL</code>, of course) are now uniformized to follow the <a target="_blank" rel="noopener" href="https://url.spec.whatwg.org/#api"><code>URLUtils</code> API</a> (minus <code>searchParams</code> for now).</li>
...
<p>Finally, if you’re a loyal jsdom fan whose made it this far into the changelog, I’d urge you to come join us in <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/jsdom/jsdom/issues/1139" >#1139</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>, where we are brainstorming a modernized jsdom API that could get rid of many of the warts in the current one.</p>

        <h2 id="5-6-1"   >
          <a href="#5-6-1" class="heading-link"><i class="fas fa-link"></i></a><a href="#5-6-1" class="headerlink" title="5.6.1"></a>5.6.1</h2>
      <ul>
<li>Fixed an accidentally-created global <code>attribute</code> variable if you ever called <code>createAttributeNS</code>.</li>
<li>Dependency upgrades fixed a couple of bugs, although you would have gotten these anyway with a clean jsdom v5.6.0 install:<ul>
...
<li>Selectors for the empty string, like <code>div[title=&quot;&quot;]</code>, now work correctly, as of <code>nwmatcher</code> v1.3.6.</li>
        ...
        <h2 id="5-6-0"   >
          <a href="#5-6-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#5-6-0" class="headerlink" title="5.6.0"></a>5.6.0</h2>
      <ul>
<li><code>virtualConsole.sendTo</code> now returns <code>this</code>, allowing for <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/jsdom/jsdom/tree/60ccb9b318d0bae8fe37e19af5af444b9c98ddac#forward-a-windows-console-output-to-the-iojs-console" >a nice shorthand</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>. (jeffcarp)</li>
</ul>

        <h2 id="5-5-0"   >
          <a href="#5-5-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#5-5-0" class="headerlink" title="5.5.0"></a>5.5.0</h2>
      <ul>
...
<li>Rewrote cloning code (underlying <code>cloneNode</code> and <code>importNode</code>), fixing a number of issues:<ul>
<li>Elements with weird tag names, of the type that only the parser can normally create, can now be cloned (<span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/jsdom/jsdom/issues/1142" >#1142</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>)</li>
...
<p>Additionally, Joris-van-der-Wel added <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/jsdom/jsdom/blob/master/Contributing.md#running-the-benchmarks" >a benchmarking framework</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>, and a number of benchmarks, which should help us avoid performance regressions going forward, and also make targeted performance fixes. We’re already investigating <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/jsdom/jsdom/issues/1156" >some real-world issues</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span> using this framework. Very exciting!</p>

        <h2 id="5-4-3"   >
          <a href="#5-4-3" class="heading-link"><i class="fas fa-link"></i></a><a href="#5-4-3" class="headerlink" title="5.4.3"></a>5.4.3</h2>
      <ul>
<li>Incorporated upstream fix for setting <code>el.style.cssText</code> to an invalid value, which should be ignored instead of causing an error to be thrown. This same bug has also caused an error while setting the style attribute to an invalid value, ever since 5.4.0. (Joris-van-der-Wel; chad3814 upstream)</li>
        ...
        <h2 id="5-4-2"   >
          <a href="#5-4-2" class="heading-link"><i class="fas fa-link"></i></a><a href="#5-4-2" class="headerlink" title="5.4.2"></a>5.4.2</h2>
      <ul>
<li>Fixed license metadata to conform to latest npm standards.</li>
</ul>

        <h2 id="5-4-1"   >
          <a href="#5-4-1" class="heading-link"><i class="fas fa-link"></i></a><a href="#5-4-1" class="headerlink" title="5.4.1"></a>5.4.1</h2>
      <ul>
<li>Fixed to work with browserify again (regression introduced in v5.4.0).</li>
</ul>

        <h2 id="5-4-0"   >
          <a href="#5-4-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#5-4-0" class="headerlink" title="5.4.0"></a>5.4.0</h2>
...
<ul>
<li>Added support for the default HTML stylesheet when using <code>window.getComputedStyle</code>! (akhaku)<ul>
<li>Notably, this makes jQuery’s <code>show()</code> and <code>hide()</code> methods now work correctly; see <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/jsdom/jsdom/issues/994" >#994</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>.</li>
</ul>
</li>
<li>Added support for named properties on <code>window</code>: any elements with an <code>id</code> attribute, or certain elements with a <code>name</code> attribute, will cause properties to show up on the <code>window</code>, and thus as global variables within the jsdom. (Joris-van-der-Wel)<ul>
...
<ul>
<li>Implemented the <a target="_blank" rel="noopener" href="https://dom.spec.whatwg.org/#nondocumenttypechildnode"><code>NonDocumentTypeChildNode</code></a> mixin. Practically, this means adding <code>nextElementSibling</code> and <code>previousElementSibling</code> to <code>Element</code> and the various types of <code>CharacterData</code>. (brandon-bethke-neudesic)</li>
<li>Updated <code>StyleSheetList</code> to inherit from <code>Array</code>, as per the latest CSSOM spec.</li>
<li>Overhauled the handling of attributes throughout the DOM, to follow the spec more exactly.<ul>
...
<li>Some weirdnesses around the <code>style</code> attribute were fixed along the way; see e.g. <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/jsdom/jsdom/issues/1109" >#1109</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>.</li>
...
<li>Removed a few functions that were erroneously added to <code>window</code>: <code>mapper</code>, <code>mapDOMNodes</code>, and <code>visitTree</code>. (Joris-van-der-Wel)</li>
        ...
        <h2 id="5-3-0"   >
          <a href="#5-3-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#5-3-0" class="headerlink" title="5.3.0"></a>5.3.0</h2>
      <ul>
<li>Added a <code>virtualConsole</code> option to the document creation methods, along with the <code>jsdom.createVirtualConsole</code> factory. (See <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/jsdom/jsdom/blob/dbf88666d1152576237ed1c741263f5516bb4005/README.md#capturing-console-output" >examples in the readme</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>.) With this option you can install a virtual console before the document is even created, thus allowing you to catch any virtual console events that occur during initialization. (jeffcarp)</li>
</ul>

        <h2 id="5-2-0"   >
          <a href="#5-2-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#5-2-0" class="headerlink" title="5.2.0"></a>5.2.0</h2>
      <ul>
<li>Implemented much of the <a target="_blank" rel="noopener" href="https://dom.spec.whatwg.org/#interface-parentnode"><code>ParentNode</code></a> mixin (Joris-van-der-Wel):<ul>
...
<li>Fixed relative stylesheet resolution when using <code>@import</code>. (dbo)</li>
        ...
        <h2 id="5-1-0"   >
          <a href="#5-1-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#5-1-0" class="headerlink" title="5.1.0"></a>5.1.0</h2>
      <ul>
...
<li>Added a fast failure in Node.js™ with a clear error message, so that people don’t get confused by syntax errors.</li>
        ...
        <h2 id="5-0-1"   >
          <a href="#5-0-1" class="heading-link"><i class="fas fa-link"></i></a><a href="#5-0-1" class="headerlink" title="5.0.1"></a>5.0.1</h2>
      <ul>
...
<li>Fixed <code>document.write(&quot;&quot;)</code> to no longer try to write <code>&quot;&lt;html&gt;&lt;head&gt;&lt;/head&gt;&lt;body&gt;&lt;/body&gt;&lt;/html&gt;&quot;</code>.</li>
        ...
        <h2 id="5-0-0"   >
          <a href="#5-0-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#5-0-0" class="headerlink" title="5.0.0"></a>5.0.0</h2>
      <p>This release overhauls how cookies are handled in jsdom to be less fiddly and more like-a-browser. The work for this was done by <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/inikulin" >@inikulin</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>, who is also our beloved parse5 maintainer.</p>
...
<p>Finally, it’s worth noting that we now delegate our cookie handling in general to the <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://www.npmjs.com/package/tough-cookie" >tough-cookie</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span> package, which should hopefully mean that it now captures many of the behaviors that were previously missing (for example <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/jsdom/jsdom/issues/1027" >#1027</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>). @inikulin is working on <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/goinstant/tough-cookie/pull/30" >a large pull request to fix tough-cookie to be more spec compliant</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>, which should automatically be picked up by jsdom installs once it is merged.</p>

        <h2 id="4-5-1"   >
          <a href="#4-5-1" class="heading-link"><i class="fas fa-link"></i></a><a href="#4-5-1" class="headerlink" title="4.5.1"></a>4.5.1</h2>
      <ul>
<li>Removed unnecessary browserify dependency that was erroneously included in 4.5.0.</li>
</ul>

        <h2 id="4-5-0"   >
          <a href="#4-5-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#4-5-0" class="headerlink" title="4.5.0"></a>4.5.0</h2>
      <ul>
<li>Added <code>document.currentScript</code>. (jeffcarp)</li>
</ul>

        <h2 id="4-4-0"   >
          <a href="#4-4-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#4-4-0" class="headerlink" title="4.4.0"></a>4.4.0</h2>
      <ul>
<li>All resources are now loaded with the <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://www.npmjs.com/package/request" >request</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span> package, which means that e.g. GZIPped resources will be properly uncompressed, redirects will be followed, and more. This was previously the case only for URLs passed directly to <code>jsdom.env</code>, and not for sub-resources inside the resulting page. (ssesha)</li>
</ul>

        <h2 id="4-3-0"   >
          <a href="#4-3-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#4-3-0" class="headerlink" title="4.3.0"></a>4.3.0</h2>
      <ul>
...
<li>Made the <code>click()</code> method trigger a <code>MouseEvent</code> instead of just an <code>Event</code>.</li>
        ...
        <h2 id="4-2-0"   >
          <a href="#4-2-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#4-2-0" class="headerlink" title="4.2.0"></a>4.2.0</h2>
      <ul>
<li>Added a second parameter to <code>UIEvent</code>, <code>MouseEvent</code>, and <code>MutationEvent</code>, which for now just behaves the same as that for <code>Event</code>. (Rich-Harris)</li>
        ...
        <h2 id="4-1-0"   >
          <a href="#4-1-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#4-1-0" class="headerlink" title="4.1.0"></a>4.1.0</h2>
      <ul>
<li>Added a second parameter to the <code>Event</code> constructor, which allows you to set the <code>bubbles</code> and <code>cancelable</code> properties. (brandon-bethke-neudesic)</li>
        ...
        <h2 id="4-0-5"   >
          <a href="#4-0-5" class="heading-link"><i class="fas fa-link"></i></a><a href="#4-0-5" class="headerlink" title="4.0.5"></a>4.0.5</h2>
      <ul>
...
<p><em>Note:</em> this probably should have been a minor version number increment (i.e. 4.1.0 instead of 4.0.5), since it added <code>HTMLUnknownElement</code>. We apologize for the deviation from semver.</p>
        ...
        <h2 id="4-0-4"   >
          <a href="#4-0-4" class="heading-link"><i class="fas fa-link"></i></a><a href="#4-0-4" class="headerlink" title="4.0.4"></a>4.0.4</h2>
      <ul>
<li>Fixed parsing of doctypes by relying on the information provided by the html parser if possible.</li>
</ul>

        <h2 id="4-0-3"   >
          <a href="#4-0-3" class="heading-link"><i class="fas fa-link"></i></a><a href="#4-0-3" class="headerlink" title="4.0.3"></a>4.0.3</h2>
      <ul>
...
<li>Sped up window creation with <code>jsdom.env</code> by ~600%, for the special case when no scripts are to be executed.</li>
        ...
        <h2 id="4-0-2"   >
          <a href="#4-0-2" class="heading-link"><i class="fas fa-link"></i></a><a href="#4-0-2" class="headerlink" title="4.0.2"></a>4.0.2</h2>
      <ul>
...
<li>Fixed a regression in our browser support that required Chrome 41 as of 4.0.1; now Chrome 40 will work, as well as (in theory, although less well-tested) the latest stable versions of Firefox and IE.</li>
        ...
        <h2 id="4-0-1"   >
          <a href="#4-0-1" class="heading-link"><i class="fas fa-link"></i></a><a href="#4-0-1" class="headerlink" title="4.0.1"></a>4.0.1</h2>
      <ul>
...
<li>A couple fixes from updated dependencies (although you would have gotten these anyway with a fresh install, due to floating version specifiers):<ul>
...
<li>parse5 minimum version bumped from 1.3.1 to 1.3.2 to, fixing the parsing of <code>&lt;form&gt;</code> elements inside <code>&lt;template&gt;</code> elements.</li>
        ...
        <h2 id="4-0-0"   >
          <a href="#4-0-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#4-0-0" class="headerlink" title="4.0.0"></a>4.0.0</h2>
...
<p>Note that as of this release, jsdom no longer works with Node.js™, and instead requires io.js. You are still welcome to install a release in <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/jsdom/jsdom/tree/3.x" >the 3.x series</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span> if you are stuck on legacy technology like Node.js™.</p>
...
<li>The non-standard <code>document.parentWindow</code> was removed, in favor of the standard <code>document.defaultView</code>. Our apologies for encouraging use of <code>parentWindow</code> in our README, tests, and examples.</li>
        ...
        <h2 id="3-1-2"   >
          <a href="#3-1-2" class="heading-link"><i class="fas fa-link"></i></a><a href="#3-1-2" class="headerlink" title="3.1.2"></a>3.1.2</h2>
      <ul>
...
<li>Fixed, at least partially, the ability to run <code>&lt;script&gt;</code>s inside a browserified jsdom instance. This is done by dynamically rewriting the source code so that global variable references become explicit references to <code>window.variableName</code>, so it is not foolproof.</li>
        ...
        <h2 id="3-1-1"   >
          <a href="#3-1-1" class="heading-link"><i class="fas fa-link"></i></a><a href="#3-1-1" class="headerlink" title="3.1.1"></a>3.1.1</h2>
      <ul>
...
<li>Fixed a couple small issues while browserifying, mainly around <code>jsdom.env</code>. However, while doing so discovered that <code>&lt;script&gt;</code>s in general don’t work too well in a browserified jsdom; see <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/jsdom/jsdom/issues/1023" >#1023</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>.</li>
</ul>

        <h2 id="3-1-0"   >
          <a href="#3-1-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#3-1-0" class="headerlink" title="3.1.0"></a>3.1.0</h2>
      <ul>
<li>Added support for <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/jsdom/jsdom#custom-external-resource-loader" >custom external resource loading</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>. (tobie)</li>
</ul>

        <h2 id="3-0-3"   >
          <a href="#3-0-3" class="heading-link"><i class="fas fa-link"></i></a><a href="#3-0-3" class="headerlink" title="3.0.3"></a>3.0.3</h2>
      <ul>
<li>Fixed some stray byte-order marks in a couple files, which incidentally <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/substack/node-browserify/issues/1095" >break Browserify</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>. (sterpe)</li>
</ul>

        <h2 id="3-0-2"   >
          <a href="#3-0-2" class="heading-link"><i class="fas fa-link"></i></a><a href="#3-0-2" class="headerlink" title="3.0.2"></a>3.0.2</h2>
      <ul>
<li>Fixed another edge case where unchecking a radio button would incorrectly uncheck radio buttons outside the containing form. (zpao)</li>
        ...
        <h2 id="3-0-1"   >
          <a href="#3-0-1" class="heading-link"><i class="fas fa-link"></i></a><a href="#3-0-1" class="headerlink" title="3.0.1"></a>3.0.1</h2>
      <ul>
...
<li>Handle empty HTML strings being passed to <code>jsdom.env</code>‘s <code>html</code> option. (fluffybunnies)</li>
        ...
        <h2 id="3-0-0"   >
          <a href="#3-0-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#3-0-0" class="headerlink" title="3.0.0"></a>3.0.0</h2>
...
<p>3.0.x will be the last release of jsdom to support Node.js. All future releases (starting with 4.0.0) will require <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://iojs.org/" >io.js</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>, whose <a target="_blank" rel="noopener" href="https://github.com/iojs/io.js/blob/v1.x/CHANGELOG.md#vm">new <code>vm</code> module</a> will allow us to remove our contextify native-module dependency. (Given that I submitted the relevant patch to joyent&#x2F;node <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/joyent/node/commit/7afdba6e0bc3b69c2bf5fdbd59f938ac8f7a64c5" >1.5 years ago</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>, I’m very excited that we can finally use it!)</p>
<ul>
...
<li>Introduced a new “virtual console” abstraction for capturing console output from inside the page. <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/jsdom/jsdom#capturing-console-output" >See the readme for more information.</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span> Note that <code>console.error</code> will no longer contribute to the (non-standard, and likely dying in the future) <code>window.errors</code> array. (jeffcarp)</li>
...
<li>Moved some properties to <code>Document.prototype</code> and <code>Window.prototype</code> instead of setting them as own properties during the document&#x2F;window creation. This should improve memory usage (as well as spec compliance).</li>
      ...
      <p>This release is largely a refactoring release to remove the defunct concept of “levels” from jsdom, in favor of the <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://wiki.whatwg.org/wiki/FAQ#What_does_.22Living_Standard.22_mean.3F" >living standard model</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span> that browsers follow. Although the code is still organized that way, that’s now <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/jsdom/jsdom/blob/2ff5747488ad4b518fcef97a026c82eab42a0a14/lib/README.md" >noted as a historical artifact</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>. The public API changes while doing so were fairly minimal, but this sets the stage for a cleaner jsdom code structure going forward.</p>
<ul>
...
<li>Fix: <code>querySelector</code> correctly coerces its argument to a string (1.2.2 previously fixed this for <code>querySelectorAll</code>).</li>
        ...
        <h2 id="1-5-0"   >
          <a href="#1-5-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#1-5-0" class="headerlink" title="1.5.0"></a>1.5.0</h2>
      <ul>
<li>Add: missing <code>window.console</code> methods, viz. <code>assert</code>, <code>clear</code>, <code>count</code>, <code>debug</code>, <code>group</code>, <code>groupCollapse</code>, <code>groupEnd</code>, <code>table</code>, <code>time</code>, <code>timeEnd</code>, and <code>trace</code>. All except <code>assert</code> do nothing for now, but see <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/jsdom/jsdom/issues/979" >#979</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span> for future plans. (jeffcarp)</li>
<li>Tweak: make <code>childNodes</code>, and the many places in jsdom that use it, much faster. (Joris-van-der-Wel)</li>
</ul>

        <h2 id="1-4-1"   >
          <a href="#1-4-1" class="heading-link"><i class="fas fa-link"></i></a><a href="#1-4-1" class="headerlink" title="1.4.1"></a>1.4.1</h2>
      <ul>
<li>Tweak: faster implementation of <code>NodeList.prototype.length</code>, which should speed up common operations like <code>appendChild</code> and similar. (Joris-van-der-Wel)</li>
        ...
        <h2 id="1-4-0"   >
          <a href="#1-4-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#1-4-0" class="headerlink" title="1.4.0"></a>1.4.0</h2>
      <ul>
...
<li>Fix: <code>div.toString()</code> now returns <code>[object HTMLDivElement]</code>. (AVGP)</li>
        ...
        <h2 id="1-3-2"   >
          <a href="#1-3-2" class="heading-link"><i class="fas fa-link"></i></a><a href="#1-3-2" class="headerlink" title="1.3.2"></a>1.3.2</h2>
      <ul>
<li>Fix: check if <code>module.parent</code> exists before using it to construct a document’s initial URL. Apparently some testing frameworks like Jest do not correctly emulate the module environment; this compensates. (SegFaultx64)</li>
        ...
        <h2 id="1-3-1"   >
          <a href="#1-3-1" class="heading-link"><i class="fas fa-link"></i></a><a href="#1-3-1" class="headerlink" title="1.3.1"></a>1.3.1</h2>
      <ul>
<li>Fix: changing attributes on <code>&lt;option&gt;</code> elements will now have the correct consequences. For example changing the <code>id</code> attribute now interacts correctly with <code>document.getElementById</code>. (Joris-van-der-Wel)</li>
        ...
        <h2 id="1-3-0"   >
          <a href="#1-3-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#1-3-0" class="headerlink" title="1.3.0"></a>1.3.0</h2>
      <ul>
<li>Add: moved <code>focus</code> and <code>blur</code> methods to <code>HTMLElement.prototype</code>, instead of having them only be present on certain element prototypes. Our focus story is still not very spec-compliant, but this is a step in the right direction. (vincentsiao)</li>
        ...
        <h2 id="1-2-3"   >
          <a href="#1-2-3" class="heading-link"><i class="fas fa-link"></i></a><a href="#1-2-3" class="headerlink" title="1.2.3"></a>1.2.3</h2>
      <ul>
<li>Tweak: improve performance of <code>Node.prototype.insertBefore</code>, <code>Node.prototype.removeChild</code>, and several <code>AttributeList</code> methods. (Joris-van-der-Wel)</li>
        ...
        <h2 id="1-2-2"   >
          <a href="#1-2-2" class="heading-link"><i class="fas fa-link"></i></a><a href="#1-2-2" class="headerlink" title="1.2.2"></a>1.2.2</h2>
      <ul>
...
<li>Fix: <code>document.toString()</code> now returns <code>[object HTMLDocument]</code>. (jeffcarp)</li>
        ...
        <h2 id="1-2-1"   >
          <a href="#1-2-1" class="heading-link"><i class="fas fa-link"></i></a><a href="#1-2-1" class="headerlink" title="1.2.1"></a>1.2.1</h2>
      <ul>
<li>Fix: handling of <code>&lt;template&gt;</code> element parsing and serialization, now that it is supported by parse5. (inikulin)</li>
</ul>

        <h2 id="1-2-0"   >
          <a href="#1-2-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#1-2-0" class="headerlink" title="1.2.0"></a>1.2.0</h2>
      <ul>
...
<li>Update: no longer requiring separate <code>cssstyle</code> and <code>cssstyle-browserify</code> dependencies; now <code>cssstyle</code> can be used directly. This also un-pins the <code>cssstyle</code> dependency so that future fixes arrive as they appear upstream.</li>
      ...
      <ul>
<li>Fix: temporarily pin <code>cssstyle</code> dependency to at most 0.2.18 until <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/chad3814/CSSStyleDeclaration/issues/20" >chad3814&#x2F;CSSStyleDeclaration#20</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span> is fixed.</li>
...
<li>Fix: the return value of <code>EventTarget.prototype.dispatchEvent</code> should be <code>true</code> when the default is <em>not</em> prevented; previously it was the opposite. (eventualbuddha)</li>
      ...
      <p>For a consolidated list of changes from 0.11.1 to 1.0.0, see <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/jsdom/jsdom/wiki/Changes-from-0.11.1-to-1.0.0" >this wiki page</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>.</p>
<ul>
...
<li>Fix: <code>value</code> and <code>defaultValue</code> properties of a <code>HTMLInputElement</code> are now correctly synced to the <code>value=&quot;&quot;</code> attribute. (Sebmaster)</li>
        ...
        <h2 id="1-0-0-pre-7"   >
          <a href="#1-0-0-pre-7" class="heading-link"><i class="fas fa-link"></i></a><a href="#1-0-0-pre-7" class="headerlink" title="1.0.0-pre.7"></a>1.0.0-pre.7</h2>
      <ul>
...
<li>Tweak: memoize various DOM-querying functions (e.g. <code>getElementsByTagName</code>, <code>querySelector</code>, etc.) to improve performance. (ccarpita)</li>
        ...
        <h2 id="1-0-0-pre-6"   >
          <a href="#1-0-0-pre-6" class="heading-link"><i class="fas fa-link"></i></a><a href="#1-0-0-pre-6" class="headerlink" title="1.0.0-pre.6"></a>1.0.0-pre.6</h2>
      <ul>
...
<li>Fix: same-named radio inputs should not be mutually exclusive unless they are in the same form. (stof)</li>
        ...
        <h2 id="1-0-0-pre-5"   >
          <a href="#1-0-0-pre-5" class="heading-link"><i class="fas fa-link"></i></a><a href="#1-0-0-pre-5" class="headerlink" title="1.0.0-pre.5"></a>1.0.0-pre.5</h2>
      <ul>
<li>Fix: sometimes calling <code>window.close()</code> would cause a segfault. (paton)</li>
</ul>

        <h2 id="1-0-0-pre-4"   >
          <a href="#1-0-0-pre-4" class="heading-link"><i class="fas fa-link"></i></a><a href="#1-0-0-pre-4" class="headerlink" title="1.0.0-pre.4"></a>1.0.0-pre.4</h2>
      <ul>
<li>Fix: attributes and elements now have their <code>prefix</code>, <code>localName</code>, and <code>namespaceURI</code> properties set correctly in all cases. (Excepting <code>application/xhtml+xml</code> mode, which jsdom does not support yet.) (Sebmaster)</li>
        ...
        <h2 id="1-0-0-pre-3"   >
          <a href="#1-0-0-pre-3" class="heading-link"><i class="fas fa-link"></i></a><a href="#1-0-0-pre-3" class="headerlink" title="1.0.0-pre.3"></a>1.0.0-pre.3</h2>
      <ul>
<li>Fix: void elements no longer parsed correctly when using <code>innerHTML</code>. This was a regression between 0.11.1 and 1.0.0-pre.1. (Sebmaster)</li>
        ...
        <h2 id="1-0-0-pre-2"   >
          <a href="#1-0-0-pre-2" class="heading-link"><i class="fas fa-link"></i></a><a href="#1-0-0-pre-2" class="headerlink" title="1.0.0-pre.2"></a>1.0.0-pre.2</h2>
      <ul>
<li>Fix: parsing and serialization of attributes in the form <code>x:y</code>, e.g. <code>xmlns:xlink</code> or <code>xlink:href</code>. This was a regression between 0.11.1 and 1.0.0-pre.1. (Sebmaster)</li>
        ...
        <h2 id="1-0-0-pre-1"   >
          <a href="#1-0-0-pre-1" class="heading-link"><i class="fas fa-link"></i></a><a href="#1-0-0-pre-1" class="headerlink" title="1.0.0-pre.1"></a>1.0.0-pre.1</h2>
      <p>This is a prerelease of jsdom’s first major version. It incorporates several great additions, as well as a general cleanup of the API surface, which make it more backward-incompatible than usual. Starting with the 1.0.0 release, we will be following semantic versioning, so that you can depend on stability within major version ranges. But we still have <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/jsdom/jsdom/issues?q=is:open+is:issue+milestone:1.0" >a few more issues</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span> before we can get there, so I don’t want to do 1.0.0 quite yet.</p>
<p>This release owes a special thanks to <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/Sebmaster" >@Sebmaster</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>, for his amazing work taking on some of the hardest problems in jsdom and solving them with gusto.</p>

        <h3 id="Major-changes"   >
          <a href="#Major-changes" class="heading-link"><i class="fas fa-link"></i></a><a href="#Major-changes" class="headerlink" title="Major changes"></a>Major changes</h3>
      <ul>
...
<li>An overhaul of the <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/jsdom/jsdom#initialization-lifecycle" >initialization lifecycle</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>, to bring more control and address common use cases. (Sebmaster)</li>
<li>The excellent <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://npmjs.org/package/parse5" >parse5</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span> HTML parser is now the default parser, fixing many parsing bugs and giving us full, official-test-suite-passing HTML parsing support. This especially impacts documents that didn’t include optional tags like <code>&lt;html&gt;</code>, <code>&lt;head&gt;</code>, or <code>&lt;body&gt;</code> in their source. We also use parse5 for serialization, fixing many bugs there. (Sebmaster)</li>
<li>As part of the new parser story, we are not supporting XML for now. It might work if you switch to a different parser (e.g. htmlparser2), but in the end, HTML and XML are very different, and we are not attempting to be an XML DOM. That said, we eventually want to support XML to the same extent browsers do (i.e., support XHTML and SVG, with an appropriate MIME type switch); this is being planned in <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/jsdom/jsdom/issues/820" >#820</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>.</li>
</ul>

        <h3 id="Removed-jsdom-APIs"   >
          <a href="#Removed-jsdom-APIs" class="heading-link"><i class="fas fa-link"></i></a><a href="#Removed-jsdom-APIs" class="headerlink" title="Removed jsdom APIs"></a>Removed jsdom APIs</h3>
      <ul>
...
<li><code>jsdom.windowAugmentation</code></li>
        ...
        <h3 id="Changed-jsdom-APIs"   >
          <a href="#Changed-jsdom-APIs" class="heading-link"><i class="fas fa-link"></i></a><a href="#Changed-jsdom-APIs" class="headerlink" title="Changed jsdom APIs"></a>Changed jsdom APIs</h3>
      <ul>
<li><code>jsdom.jsdom</code> no longer takes a level as its second argument.</li>
<li><code>jsdom.jQueryify</code> now requires a jQuery URL, since <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="http://blog.jquery.com/2014/07/03/dont-use-jquery-latest-js/" >always picking the latest was a bad idea</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>.</li>
</ul>

        <h3 id="Removed-non-standard-DOM-APIs"   >
          <a href="#Removed-non-standard-DOM-APIs" class="heading-link"><i class="fas fa-link"></i></a><a href="#Removed-non-standard-DOM-APIs" class="headerlink" title="Removed non-standard DOM APIs"></a>Removed non-standard DOM APIs</h3>
      <ul>
...
<li><code>document.innerHTML</code> and <code>document.outerHTML</code>: use the new <code>jsdom.serializeDocument</code> to include the DOCTYPE, or use <code>document.documentElement.outerHTML</code> to omit it.</li>
        ...
        <h3 id="Other-fixes"   >
          <a href="#Other-fixes" class="heading-link"><i class="fas fa-link"></i></a><a href="#Other-fixes" class="headerlink" title="Other fixes"></a>Other fixes</h3>
      <ul>
...
<li>Fix <code>document.cookie = null</code> to not throw, but instead just do nothing. (kapouer)</li>
        ...
        <h2 id="0-11-1"   >
          <a href="#0-11-1" class="heading-link"><i class="fas fa-link"></i></a><a href="#0-11-1" class="headerlink" title="0.11.1"></a>0.11.1</h2>
      <ul>
...
<li>Fix: <code>jsdom.jQueryify</code> was using the wrong URL for jQuery by default. (lukasbuenger)</li>
      ...
      <ul>
<li>Add: new default level, <code>living</code>, reflecting our focus on the <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="http://dom.spec.whatwg.org/" >DOM Living Standard</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span> and the <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="http://www.whatwg.org/specs/web-apps/current-work/multipage/" >HTML Living Standard</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>, which are what browsers actually implement. This should open the door for more features of the modern DOM and HTML specs to be implemented in jsdom. (robotlovesyou)</li>
...
<li>Fix: a bug involving invalid script paths and <code>jsdom.jQueryify</code>. (Sebmaster)</li>
        ...
        <h2 id="0-10-6"   >
          <a href="#0-10-6" class="heading-link"><i class="fas fa-link"></i></a><a href="#0-10-6" class="headerlink" title="0.10.6"></a>0.10.6</h2>
      <ul>
...
<li>Tweak: lazy-load the request module, to improve overall jsdom loading time. (tantaman)</li>
        ...
        <h2 id="0-10-5"   >
          <a href="#0-10-5" class="heading-link"><i class="fas fa-link"></i></a><a href="#0-10-5" class="headerlink" title="0.10.5"></a>0.10.5</h2>
      <ul>
...
<li>Fix: when serializing void elements, don’t include a <code> /</code>: i.e. the result is now <code>&lt;br&gt;</code> instead of <code>&lt;br /&gt;</code>.</li>
        ...
        <h2 id="0-10-4"   >
          <a href="#0-10-4" class="heading-link"><i class="fas fa-link"></i></a><a href="#0-10-4" class="headerlink" title="0.10.4"></a>0.10.4</h2>
      <ul>
...
<li>Add: <code>querySelector</code> and <code>querySelectorAll</code> methods to <code>DocumentFragment</code>s. (Joris-van-der-Wel)</li>
        ...
        <h2 id="0-10-3"   >
          <a href="#0-10-3" class="heading-link"><i class="fas fa-link"></i></a><a href="#0-10-3" class="headerlink" title="0.10.3"></a>0.10.3</h2>
      <ul>
...
<li>Fix: <code>window.location</code> properties were not updating correctly after using <code>pushState</code> or <code>replaceState</code>. (toomanydaves)</li>
        ...
        <h2 id="0-10-1"   >
          <a href="#0-10-1" class="heading-link"><i class="fas fa-link"></i></a><a href="#0-10-1" class="headerlink" title="0.10.1"></a>0.10.1</h2>
      <ul>
<li>Fix: <code>window.location.port</code> should default to <code>&quot;&quot;</code>, not <code>null</code>. (bpeacock)</li>
</ul>

        <h2 id="0-10-0"   >
          <a href="#0-10-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#0-10-0" class="headerlink" title="0.10.0"></a>0.10.0</h2>
      <ul>
<li>Add: a more complete <code>document.cookie</code> implementation, that supports multiple cookies. Note that options like <code>path</code>, <code>max-age</code>, etc. are still ignored. (dai-shi)</li>
        ...
        <h2 id="0-9-0"   >
          <a href="#0-9-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#0-9-0" class="headerlink" title="0.9.0"></a>0.9.0</h2>
      <ul>
...
<li>Fix: reference typed arrays in a way that doesn’t immediately break on Node 0.6. Node 0.6 isn’t supported in general, though. (kangax)</li>
        ...
        <h2 id="0-8-11"   >
          <a href="#0-8-11" class="heading-link"><i class="fas fa-link"></i></a><a href="#0-8-11" class="headerlink" title="0.8.11"></a>0.8.11</h2>
      <ul>
...
<li>Change: remove <code>__proto__</code>, <code>__defineGetter__</code>, and <code>__defineSetter__</code> usage, as part of a project to make jsdom work better across multiple environments. (lawnsea)</li>
        ...
        <h2 id="0-8-10"   >
          <a href="#0-8-10" class="heading-link"><i class="fas fa-link"></i></a><a href="#0-8-10" class="headerlink" title="0.8.10"></a>0.8.10</h2>
      <ul>
<li>Add: <code>hash</code> property to <code>HTMLAnchorElement</code>. (fr0z3nk0)</li>
</ul>

        <h2 id="0-8-9"   >
          <a href="#0-8-9" class="heading-link"><i class="fas fa-link"></i></a><a href="#0-8-9" class="headerlink" title="0.8.9"></a>0.8.9</h2>
      <ul>
...
<li>Upgrade: <code>cssstyle</code> to 0.2.6, adding support for many shorthand properties and better unit handling.</li>
        ...
        <h2 id="0-8-8"   >
          <a href="#0-8-8" class="heading-link"><i class="fas fa-link"></i></a><a href="#0-8-8" class="headerlink" title="0.8.8"></a>0.8.8</h2>
      <ul>
<li>Fix: avoid repeated <code>NodeList.prototype.length</code> calculation, for a speed improvement. (peller)</li>
</ul>

        <h2 id="0-8-7"   >
          <a href="#0-8-7" class="heading-link"><i class="fas fa-link"></i></a><a href="#0-8-7" class="headerlink" title="0.8.7"></a>0.8.7</h2>
      <ul>
<li>Add: <code>host</code> property to <code>HTMLAnchorElement</code>. (sporchia)</li>
</ul>

        <h2 id="0-8-6"   >
          <a href="#0-8-6" class="heading-link"><i class="fas fa-link"></i></a><a href="#0-8-6" class="headerlink" title="0.8.6"></a>0.8.6</h2>
      <ul>
...
<li>Add: a dummy <code>getBoundingClientRect</code> method, that returns <code>0</code> for all properties of the rectangle, is now implemented. (F1LT3R)</li>
        ...
        <h2 id="0-8-5"   >
          <a href="#0-8-5" class="heading-link"><i class="fas fa-link"></i></a><a href="#0-8-5" class="headerlink" title="0.8.5"></a>0.8.5</h2>
      <ul>
<li>Add: <code>href</code> property on <code>CSSStyleSheet</code> instances for external CSS files. (FrozenCow)</li>
</ul>

        <h2 id="0-8-4"   >
          <a href="#0-8-4" class="heading-link"><i class="fas fa-link"></i></a><a href="#0-8-4" class="headerlink" title="0.8.4"></a>0.8.4</h2>
      <ul>
...
<li>Fix: <code>querySelector</code> and <code>querySelectorAll</code> should be on the prototypes of <code>Element</code> and <code>Document</code>, not own-properties. (mbostock)</li>
        ...
        <h2 id="0-8-3"   >
          <a href="#0-8-3" class="heading-link"><i class="fas fa-link"></i></a><a href="#0-8-3" class="headerlink" title="0.8.3"></a>0.8.3</h2>
      <ul>
<li>Fix: when auto-detecting whether the first parameter to <code>jsdom.env</code> is a HTML string or a filename, deal with long strings correctly instead of erroring. (baryshev)</li>
        ...
        <h2 id="0-8-2"   >
          <a href="#0-8-2" class="heading-link"><i class="fas fa-link"></i></a><a href="#0-8-2" class="headerlink" title="0.8.2"></a>0.8.2</h2>
      <ul>
...
<li>Fix: tag names passed to <code>createElement</code> are coerced to strings before evaluating.</li>
        ...
        <h2 id="0-8-1-hotfix"   >
          <a href="#0-8-1-hotfix" class="heading-link"><i class="fas fa-link"></i></a><a href="#0-8-1-hotfix" class="headerlink" title="0.8.1 (hotfix)"></a>0.8.1 (hotfix)</h2>
      <ul>
...
<li>Fix: update minimum htmlparser2 version, to ensure you get the latest parsing-related bugfixes.</li>
        ...
        <h2 id="0-8-0"   >
          <a href="#0-8-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#0-8-0" class="headerlink" title="0.8.0"></a>0.8.0</h2>
      <ul>
...
<li>Add: there is now a <code>window.navigator.noUI</code> property that evaluates to true, if you want to specifically distinguish jsdom in your tests.</li>
        ...
        <h2 id="0-7-0"   >
          <a href="#0-7-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#0-7-0" class="headerlink" title="0.7.0"></a>0.7.0</h2>
      <ul>
...
<li>Add: when using a non-implemented feature, mention exactly what it was that is not implemented in the error message. (papandreou)</li>
        ...
        <h2 id="0-6-5"   >
          <a href="#0-6-5" class="heading-link"><i class="fas fa-link"></i></a><a href="#0-6-5" class="headerlink" title="0.6.5"></a>0.6.5</h2>
      <ul>
<li>Fix: custom attributes whose names were the same as properties of <code>Object.prototype</code>, e.g. <code>&quot;constructor&quot;</code>, would confuse jsdom massively.</li>
        ...
        <h2 id="0-6-4"   >
          <a href="#0-6-4" class="heading-link"><i class="fas fa-link"></i></a><a href="#0-6-4" class="headerlink" title="0.6.4"></a>0.6.4</h2>
      <ul>
...
<li>Add: <code>&lt;img&gt;</code> elements now fire <code>load</code> events when their <code>src</code> attributes are changed. (kapouer)</li>
        ...
        <h2 id="0-6-3"   >
          <a href="#0-6-3" class="heading-link"><i class="fas fa-link"></i></a><a href="#0-6-3" class="headerlink" title="0.6.3"></a>0.6.3</h2>
      <ul>
<li>Fix: better automatic detection of URLs vs. HTML fragments when using <code>jsdom.env</code>. (jden)</li>
</ul>

        <h2 id="0-6-2"   >
          <a href="#0-6-2" class="heading-link"><i class="fas fa-link"></i></a><a href="#0-6-2" class="headerlink" title="0.6.2"></a>0.6.2</h2>
      <ul>
...
<li>Fix: node-canvas integration, which had been broken since 0.5.7.</li>
        ...
        <h2 id="0-6-1"   >
          <a href="#0-6-1" class="heading-link"><i class="fas fa-link"></i></a><a href="#0-6-1" class="headerlink" title="0.6.1"></a>0.6.1</h2>
      <ul>
...
<li>Use the correct <code>package.json</code> field <code>&quot;repository&quot;</code> instead of <code>&quot;repositories&quot;</code> to prevent npm warnings. (jonathanong)</li>
        ...
        <h2 id="0-6-0"   >
          <a href="#0-6-0" class="heading-link"><i class="fas fa-link"></i></a><a href="#0-6-0" class="headerlink" title="0.6.0"></a>0.6.0</h2>
      <p>Integrated a new HTML parser, <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://npmjs.org/package/htmlparser2" >htmlparser2</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span>, from fb55. This is an actively maintained and much less buggy parser, fixing many of our parsing issues, including:</p>
<ul>
...
<li>Attribute values can now contain any value allowed by HTML5, including e.g. <code>&gt;</code> and <code>&lt;</code>.</li>
        ...
        <h2 id="0-5-7"   >
          <a href="#0-5-7" class="heading-link"><i class="fas fa-link"></i></a><a href="#0-5-7" class="headerlink" title="0.5.7"></a>0.5.7</h2>
      <ul>
...
<li>Fix: tweaks to accuracy and speed of the <code>querySelectorAll</code> implementation.</li>
        ...
        <h2 id="0-4-1-hotfix"   >
          <a href="#0-4-1-hotfix" class="heading-link"><i class="fas fa-link"></i></a><a href="#0-4-1-hotfix" class="headerlink" title="0.4.1 (hotfix)"></a>0.4.1 (hotfix)</h2>
      <ul>
...
<li>Change: <code>NodeList</code>s no longer inconsistently have array methods. Previously, live node lists would have <code>indexOf</code>, while static node lists would have them all. Now, they have no array methods at all, as is correct per the specification.</li>
        ...
        <h2 id="0-3-4"   >
          <a href="#0-3-4" class="heading-link"><i class="fas fa-link"></i></a><a href="#0-3-4" class="headerlink" title="0.3.4"></a>0.3.4</h2>
      <ul>
<li>Fix: stylesheets with <code>@media</code> rules were crashing calls to <code>getComputedStyle</code>, e.g. those in jQuery’s initialization.</li>
        ...
        <h2 id="0-3-3"   >
          <a href="#0-3-3" class="heading-link"><i class="fas fa-link"></i></a><a href="#0-3-3" class="headerlink" title="0.3.3"></a>0.3.3</h2>
      <ul>
...
<li>Fix: <code>&lt;input&gt;</code> tags with no <code>type</code> attribute now return a default value of <code>&quot;text&quot;</code> when calling <code>inputEl.getAttribute(&quot;type&quot;)</code>.</li>
        ...
        <h2 id="0-3-2"   >
          <a href="#0-3-2" class="heading-link"><i class="fas fa-link"></i></a><a href="#0-3-2" class="headerlink" title="0.3.2"></a>0.3.2</h2>
      <ul>
...
<li>Add: support for running the tests using @aredridel’s <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://npmjs.org/package/html5" >html5</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span> parser, as a prelude toward maybe eventually making this the default and fixing various parsing bugs.</li>
</ul>

        <h2 id="0-3-1-hotfix"   >
          <a href="#0-3-1-hotfix" class="heading-link"><i class="fas fa-link"></i></a><a href="#0-3-1-hotfix" class="headerlink" title="0.3.1 (hotfix)"></a>0.3.1 (hotfix)</h2>
      <ul>
...
<li>Change: turning off mutation events is not supported, since doing so breaks external-resource fetching.</li>
        ...
        <h2 id="0-2-19"   >
          <a href="#0-2-19" class="heading-link"><i class="fas fa-link"></i></a><a href="#0-2-19" class="headerlink" title="0.2.19"></a>0.2.19</h2>
      <ul>
...
<li>Add: New <code>SkipExternalResources</code> feature accepts a regular expression. (fgalassi)</li>
        ...
        <h2 id="0-2-18"   >
          <a href="#0-2-18" class="heading-link"><i class="fas fa-link"></i></a><a href="#0-2-18" class="headerlink" title="0.2.18"></a>0.2.18</h2>
      <ul>
<li>Un-revert: cssstyle has fixed its memory problems, so we get back accurate <code>cssText</code> and <code>style</code> properties again.</li>
        ...
        <h2 id="0-2-17-hotfix"   >
          <a href="#0-2-17-hotfix" class="heading-link"><i class="fas fa-link"></i></a><a href="#0-2-17-hotfix" class="headerlink" title="0.2.17 (hotfix)"></a>0.2.17 (hotfix)</h2>
      <ul>
...
<li>Fix: cssstyle was causing out-of-memory errors on some larger real-world pages, e.g. reddit.com.</li>
        ...
        <h2 id="0-2-16"   >
          <a href="#0-2-16" class="heading-link"><i class="fas fa-link"></i></a><a href="#0-2-16" class="headerlink" title="0.2.16"></a>0.2.16</h2>
      <ul>
...
<li>Fix: many more tests passing, especially related to file:&#x2F;&#x2F;&#x2F; URLs on Windows. Tests can now be run with <code>npm test</code>.</li>
        ...
        <h2 id="0-2-15"   >
          <a href="#0-2-15" class="heading-link"><i class="fas fa-link"></i></a><a href="#0-2-15" class="headerlink" title="0.2.15"></a>0.2.15</h2>
      <ul>
...
<li>Fix: HTMLSelectElement single selection implemented its type incorrectly as ‘select’ instead of ‘select-one’ (John Roberts)</li>
        ...
        <h2 id="0-2-14"   >
          <a href="#0-2-14" class="heading-link"><i class="fas fa-link"></i></a><a href="#0-2-14" class="headerlink" title="0.2.14"></a>0.2.14</h2>
      <ul>
...
<li>Fix: jsdom.env swallows exceptions that occur in the callback (Xavi)</li>
        ...
        <h2 id="0-2-13"   >
          <a href="#0-2-13" class="heading-link"><i class="fas fa-link"></i></a><a href="#0-2-13" class="headerlink" title="0.2.13"></a>0.2.13</h2>
      <ul>
<li>Fix: remove unused style property which was causing explosions in 0.2.12 and node 0.4.7</li>
</ul>

        <h2 id="0-2-12"   >
          <a href="#0-2-12" class="heading-link"><i class="fas fa-link"></i></a><a href="#0-2-12" class="headerlink" title="0.2.12"></a>0.2.12</h2>
      <ul>
<li>Fix: do not include gmon.out&#x2F;v8.log&#x2F;tests in npm distribution</li>
</ul>

        <h2 id="0-2-11"   >
          <a href="#0-2-11" class="heading-link"><i class="fas fa-link"></i></a><a href="#0-2-11" class="headerlink" title="0.2.11"></a>0.2.11</h2>
      <ul>
...
<li>Add: upgrade sizzle from 1.0 to <span class="exturl"><a class="exturl__link"   target="_blank" rel="noopener" href="https://github.com/jquery/sizzle/commit/fe2f618106bb76857b229113d6d11653707d0b22" >fe2f6181</a><span class="exturl__icon"><i class="fas fa-external-link-alt"></i></span></span> which is roughly 1.5.1</li>
...
<li>Fix: Using querySelector <code>:not()</code> throws a <code>ReferenceError</code> (Felix Gnass)</li>
        ...
        <h2 id="0-2-10"   >
          <a href="#0-2-10" class="heading-link"><i class="fas fa-link"></i></a><a href="#0-2-10" class="headerlink" title="0.2.10"></a>0.2.10</h2>
      <ul>
...
<li>Add: verbose flag to test runner (to show tests as they are running and finishing)</li>
        ...
        <h2 id="0-2-9"   >
          <a href="#0-2-9" class="heading-link"><i class="fas fa-link"></i></a><a href="#0-2-9" class="headerlink" title="0.2.9"></a>0.2.9</h2>
      <ul>
...
<li>Fix: double load behavior when mixing jsdom.env’s <code>scripts</code> and <code>src</code> properties (cjroebuck)</li>
        ...
        <h2 id="0-2-8-hotfix"   >
          <a href="#0-2-8-hotfix" class="heading-link"><i class="fas fa-link"></i></a><a href="#0-2-8-hotfix" class="headerlink" title="0.2.8 (hotfix)"></a>0.2.8 (hotfix)</h2>
      <ul>
<li>Fix: inline event handlers are ignored by everything except for the javascript context</li>
</ul>

        <h2 id="0-2-7-hotfix"   >
          <a href="#0-2-7-hotfix" class="heading-link"><i class="fas fa-link"></i></a><a href="#0-2-7-hotfix" class="headerlink" title="0.2.7 (hotfix)"></a>0.2.7 (hotfix)</h2>
      <ul>
<li>Fix stylesheet loading</li>
</ul>

        <h2 id="0-2-6"   >
          <a href="#0-2-6" class="heading-link"><i class="fas fa-link"></i></a><a href="#0-2-6" class="headerlink" title="0.2.6"></a>0.2.6</h2>
      <ul>
...
<li>Add: jsdom.env() accepts the same features object seen in jsdom.jsdom and friends</li>
        ...
        <h2 id="0-2-5"   >
          <a href="#0-2-5" class="heading-link"><i class="fas fa-link"></i></a><a href="#0-2-5" class="headerlink" title="0.2.5"></a>0.2.5</h2>
      <ul>
...
<li>Add: fixes for DOMAttrModified mutation events (Felix Gnass)</li>
        ...
        <h2 id="0-2-4"   >
          <a href="#0-2-4" class="heading-link"><i class="fas fa-link"></i></a><a href="#0-2-4" class="headerlink" title="0.2.4"></a>0.2.4</h2>
      <ul>
...
<li>Override CSSOM to update style attribute</li>
        ...
        <h2 id="0-2-3"   >
          <a href="#0-2-3" class="heading-link"><i class="fas fa-link"></i></a><a href="#0-2-3" class="headerlink" title="0.2.3"></a>0.2.3</h2>
      <ul>
<li>Fix: segfault due to window being garbage collected prematurely<br> NOTE: you must manually close the window to free memory (window.close())</li>
</ul>

        <h2 id="0-2-2"   >
          <a href="#0-2-2" class="heading-link"><i class="fas fa-link"></i></a><a href="#0-2-2" class="headerlink" title="0.2.2"></a>0.2.2</h2>
      <ul>
...
<li>Make frame&#x2F;iframe load&#x2F;process scripts if the parent has the features enabled</li>
        ...
        <h2 id="0-2-1"   >
          <a href="#0-2-1" class="heading-link"><i class="fas fa-link"></i></a><a href="#0-2-1" class="headerlink" title="0.2.1"></a>0.2.1</h2>
      <ul>
...
</div><footer class="post-footer"><div class="post-ending ending"><div class="ending__text">------ END ------</div></div><div class="post-copyright copyright"><div class="copyright-author"><span class="copyright-author__name">Author: </span><span class="copyright-author__value"><a href="http://example.com">汪汪队</a></span></div><div class="copyright-link"><span class="copyright-link__name">Link: </span><span class="copyright-link__value"><a href="http://example.com/2023/03/24/02_%E6%95%B0%E6%8D%AE%E5%AD%98%E5%82%A8%E4%B8%8E%E5%9E%83%E5%9C%BE%E5%9B%9E%E6%94%B6/01_%E6%95%B0%E6%8D%AE%E5%AD%98%E5%82%A8/%E6%95%B0%E6%8D%AE%E5%AD%98%E5%82%A8-demo/node_modules/jsdom/Changelog/">http://example.com/2023/03/24/02_%E6%95%B0%E6%8D%AE%E5%AD%98%E5%82%A8%E4%B8%8E%E5%9E%83%E5%9C%BE%E5%9B%9E%E6%94%B6/01_%E6%95%B0%E6%8D%AE%E5%AD%98%E5%82%A8/%E6%95%B0%E6%8D%AE%E5%AD%98%E5%82%A8-demo/node_modules/jsdom/Changelog/</a></span></div><div class="copyright-notice"><span class="copyright-notice__name">Copyright: </span><span class="copyright-notice__value">All articles in this blog are licensed under <a href="https://creativecommons.org/licenses/by-nc-sa/4.0/deed.en" rel="external nofollow" target="_blank">BY-NC-SA</a> unless stating additionally</span></div></div><nav class="post-paginator paginator"><div class="paginator-prev"><a class="paginator-prev__link" href="/2023/03/24/02_%E6%95%B0%E6%8D%AE%E5%AD%98%E5%82%A8%E4%B8%8E%E5%9E%83%E5%9C%BE%E5%9B%9E%E6%94%B6/01_%E6%95%B0%E6%8D%AE%E5%AD%98%E5%82%A8/%E6%95%B0%E6%8D%AE%E5%AD%98%E5%82%A8-demo/node_modules/jsdom/README/"><span class="paginator-prev__icon"><i class="fas fa-angle-left"></i></span><span class="paginator-prev__text">[ Untitled ]</span></a></div><div class="paginator-next"><a class="paginator-next__link" href="/2023/03/24/02_%E6%95%B0%E6%8D%AE%E5%AD%98%E5%82%A8%E4%B8%8E%E5%9E%83%E5%9C%BE%E5%9B%9E%E6%94%B6/01_%E6%95%B0%E6%8D%AE%E5%AD%98%E5%82%A8/%E6%95%B0%E6%8D%AE%E5%AD%98%E5%82%A8-demo/node_modules/jsbn/README/"><span class="paginator-prev__text">[ Untitled ]</span><span class="paginator-next__icon"><i class="fas fa-angle-right"></i></span></a></div></nav></footer></div></div></div><div class="sidebar-wrap" id="sidebar-wrap"><aside class="sidebar" id="sidebar"><div class="sidebar-nav"><span class="sidebar-nav-toc current">Catalog</span><span class="sidebar-nav-ov">Overview</span></div><section class="sidebar-toc"><ol class="toc"><li class="toc-item toc-level-1"><a class="toc-link" href="#jsdom-Changelog"><span class="toc-number">1.</span> <span class="toc-text">
          jsdom Changelog</span></a><ol class="toc-child"><li class="toc-item toc-level-2"><a class="toc-link" href="#16-5-3"><span class="toc-number">1.1.</span> <span class="toc-text">
          16.5.3</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#16-5-2"><span class="toc-number">1.2.</span> <span class="toc-text">
          16.5.2</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#16-5-1"><span class="toc-number">1.3.</span> <span class="toc-text">
          16.5.1</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#16-5-0"><span class="toc-number">1.4.</span> <span class="toc-text">
          16.5.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#16-4-0"><span class="toc-number">1.5.</span> <span class="toc-text">
          16.4.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#16-3-0"><span class="toc-number">1.6.</span> <span class="toc-text">
          16.3.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#16-2-2"><span class="toc-number">1.7.</span> <span class="toc-text">
          16.2.2</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#16-2-1"><span class="toc-number">1.8.</span> <span class="toc-text">
          16.2.1</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#16-2-0"><span class="toc-number">1.9.</span> <span class="toc-text">
          16.2.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#16-1-0"><span class="toc-number">1.10.</span> <span class="toc-text">
          16.1.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#16-0-1"><span class="toc-number">1.11.</span> <span class="toc-text">
          16.0.1</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#16-0-0"><span class="toc-number">1.12.</span> <span class="toc-text">
          16.0.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#15-2-1"><span class="toc-number">1.13.</span> <span class="toc-text">
          15.2.1</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#15-2-0"><span class="toc-number">1.14.</span> <span class="toc-text">
          15.2.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#15-1-1"><span class="toc-number">1.15.</span> <span class="toc-text">
          15.1.1</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#15-1-0"><span class="toc-number">1.16.</span> <span class="toc-text">
          15.1.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#15-0-0"><span class="toc-number">1.17.</span> <span class="toc-text">
          15.0.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#14-1-0"><span class="toc-number">1.18.</span> <span class="toc-text">
          14.1.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#14-0-0"><span class="toc-number">1.19.</span> <span class="toc-text">
          14.0.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#13-2-0"><span class="toc-number">1.20.</span> <span class="toc-text">
          13.2.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#13-1-0"><span class="toc-number">1.21.</span> <span class="toc-text">
          13.1.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#13-0-0"><span class="toc-number">1.22.</span> <span class="toc-text">
          13.0.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#12-2-0"><span class="toc-number">1.23.</span> <span class="toc-text">
          12.2.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#12-1-0"><span class="toc-number">1.24.</span> <span class="toc-text">
          12.1.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#12-0-0"><span class="toc-number">1.25.</span> <span class="toc-text">
          12.0.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#11-12-0"><span class="toc-number">1.26.</span> <span class="toc-text">
          11.12.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#11-11-0"><span class="toc-number">1.27.</span> <span class="toc-text">
          11.11.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#11-10-0"><span class="toc-number">1.28.</span> <span class="toc-text">
          11.10.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#11-9-0"><span class="toc-number">1.29.</span> <span class="toc-text">
          11.9.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#11-8-0"><span class="toc-number">1.30.</span> <span class="toc-text">
          11.8.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#11-7-0"><span class="toc-number">1.31.</span> <span class="toc-text">
          11.7.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#11-6-2"><span class="toc-number">1.32.</span> <span class="toc-text">
          11.6.2</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#11-6-1"><span class="toc-number">1.33.</span> <span class="toc-text">
          11.6.1</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#11-6-0"><span class="toc-number">1.34.</span> <span class="toc-text">
          11.6.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#11-5-1"><span class="toc-number">1.35.</span> <span class="toc-text">
          11.5.1</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#11-4-0"><span class="toc-number">1.36.</span> <span class="toc-text">
          11.4.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#11-3-0"><span class="toc-number">1.37.</span> <span class="toc-text">
          11.3.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#11-2-0"><span class="toc-number">1.38.</span> <span class="toc-text">
          11.2.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#11-1-0"><span class="toc-number">1.39.</span> <span class="toc-text">
          11.1.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#11-0-0"><span class="toc-number">1.40.</span> <span class="toc-text">
          11.0.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#10-1-0"><span class="toc-number">1.41.</span> <span class="toc-text">
          10.1.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#10-0-0"><span class="toc-number">1.42.</span> <span class="toc-text">
          10.0.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#9-12-0"><span class="toc-number">1.43.</span> <span class="toc-text">
          9.12.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#9-11-0"><span class="toc-number">1.44.</span> <span class="toc-text">
          9.11.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#9-10-0"><span class="toc-number">1.45.</span> <span class="toc-text">
          9.10.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#9-9-1"><span class="toc-number">1.46.</span> <span class="toc-text">
          9.9.1</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#9-9-0"><span class="toc-number">1.47.</span> <span class="toc-text">
          9.9.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#9-8-3"><span class="toc-number">1.48.</span> <span class="toc-text">
          9.8.3</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#9-8-2"><span class="toc-number">1.49.</span> <span class="toc-text">
          9.8.2</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#9-8-1"><span class="toc-number">1.50.</span> <span class="toc-text">
          9.8.1</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#9-8-0"><span class="toc-number">1.51.</span> <span class="toc-text">
          9.8.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#9-7-1"><span class="toc-number">1.52.</span> <span class="toc-text">
          9.7.1</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#9-7-0"><span class="toc-number">1.53.</span> <span class="toc-text">
          9.7.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#9-6-0"><span class="toc-number">1.54.</span> <span class="toc-text">
          9.6.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#9-5-0"><span class="toc-number">1.55.</span> <span class="toc-text">
          9.5.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#9-4-5"><span class="toc-number">1.56.</span> <span class="toc-text">
          9.4.5</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#9-4-4"><span class="toc-number">1.57.</span> <span class="toc-text">
          9.4.4</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#9-4-3"><span class="toc-number">1.58.</span> <span class="toc-text">
          9.4.3</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#9-4-2"><span class="toc-number">1.59.</span> <span class="toc-text">
          9.4.2</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#9-4-1"><span class="toc-number">1.60.</span> <span class="toc-text">
          9.4.1</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#9-4-0"><span class="toc-number">1.61.</span> <span class="toc-text">
          9.4.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#9-3-0"><span class="toc-number">1.62.</span> <span class="toc-text">
          9.3.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#9-2-1"><span class="toc-number">1.63.</span> <span class="toc-text">
          9.2.1</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#9-2-0"><span class="toc-number">1.64.</span> <span class="toc-text">
          9.2.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#9-1-0"><span class="toc-number">1.65.</span> <span class="toc-text">
          9.1.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#9-0-0"><span class="toc-number">1.66.</span> <span class="toc-text">
          9.0.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#8-5-0"><span class="toc-number">1.67.</span> <span class="toc-text">
          8.5.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#8-4-1"><span class="toc-number">1.68.</span> <span class="toc-text">
          8.4.1</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#8-4-0"><span class="toc-number">1.69.</span> <span class="toc-text">
          8.4.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#8-3-1"><span class="toc-number">1.70.</span> <span class="toc-text">
          8.3.1</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#8-3-0"><span class="toc-number">1.71.</span> <span class="toc-text">
          8.3.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#8-2-0"><span class="toc-number">1.72.</span> <span class="toc-text">
          8.2.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#8-1-1"><span class="toc-number">1.73.</span> <span class="toc-text">
          8.1.1</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#8-1-0"><span class="toc-number">1.74.</span> <span class="toc-text">
          8.1.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#8-0-4"><span class="toc-number">1.75.</span> <span class="toc-text">
          8.0.4</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#8-0-3"><span class="toc-number">1.76.</span> <span class="toc-text">
          8.0.3</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#8-0-2"><span class="toc-number">1.77.</span> <span class="toc-text">
          8.0.2</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#8-0-1"><span class="toc-number">1.78.</span> <span class="toc-text">
          8.0.1</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#8-0-0"><span class="toc-number">1.79.</span> <span class="toc-text">
          8.0.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#7-2-2"><span class="toc-number">1.80.</span> <span class="toc-text">
          7.2.2</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#7-2-1"><span class="toc-number">1.81.</span> <span class="toc-text">
          7.2.1</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#7-2-0"><span class="toc-number">1.82.</span> <span class="toc-text">
          7.2.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#7-1-1"><span class="toc-number">1.83.</span> <span class="toc-text">
          7.1.1</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#7-1-0"><span class="toc-number">1.84.</span> <span class="toc-text">
          7.1.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#7-0-2"><span class="toc-number">1.85.</span> <span class="toc-text">
          7.0.2</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#7-0-1"><span class="toc-number">1.86.</span> <span class="toc-text">
          7.0.1</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#7-0-0"><span class="toc-number">1.87.</span> <span class="toc-text">
          7.0.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#6-5-1"><span class="toc-number">1.88.</span> <span class="toc-text">
          6.5.1</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#6-5-0"><span class="toc-number">1.89.</span> <span class="toc-text">
          6.5.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#6-4-0"><span class="toc-number">1.90.</span> <span class="toc-text">
          6.4.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#6-3-0"><span class="toc-number">1.91.</span> <span class="toc-text">
          6.3.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#6-2-0"><span class="toc-number">1.92.</span> <span class="toc-text">
          6.2.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#6-1-0"><span class="toc-number">1.93.</span> <span class="toc-text">
          6.1.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#6-0-1"><span class="toc-number">1.94.</span> <span class="toc-text">
          6.0.1</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#6-0-0"><span class="toc-number">1.95.</span> <span class="toc-text">
          6.0.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#5-6-1"><span class="toc-number">1.96.</span> <span class="toc-text">
          5.6.1</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#5-6-0"><span class="toc-number">1.97.</span> <span class="toc-text">
          5.6.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#5-5-0"><span class="toc-number">1.98.</span> <span class="toc-text">
          5.5.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#5-4-3"><span class="toc-number">1.99.</span> <span class="toc-text">
          5.4.3</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#5-4-2"><span class="toc-number">1.100.</span> <span class="toc-text">
          5.4.2</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#5-4-1"><span class="toc-number">1.101.</span> <span class="toc-text">
          5.4.1</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#5-4-0"><span class="toc-number">1.102.</span> <span class="toc-text">
          5.4.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#5-3-0"><span class="toc-number">1.103.</span> <span class="toc-text">
          5.3.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#5-2-0"><span class="toc-number">1.104.</span> <span class="toc-text">
          5.2.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#5-1-0"><span class="toc-number">1.105.</span> <span class="toc-text">
          5.1.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#5-0-1"><span class="toc-number">1.106.</span> <span class="toc-text">
          5.0.1</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#5-0-0"><span class="toc-number">1.107.</span> <span class="toc-text">
          5.0.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#4-5-1"><span class="toc-number">1.108.</span> <span class="toc-text">
          4.5.1</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#4-5-0"><span class="toc-number">1.109.</span> <span class="toc-text">
          4.5.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#4-4-0"><span class="toc-number">1.110.</span> <span class="toc-text">
          4.4.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#4-3-0"><span class="toc-number">1.111.</span> <span class="toc-text">
          4.3.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#4-2-0"><span class="toc-number">1.112.</span> <span class="toc-text">
          4.2.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#4-1-0"><span class="toc-number">1.113.</span> <span class="toc-text">
          4.1.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#4-0-5"><span class="toc-number">1.114.</span> <span class="toc-text">
          4.0.5</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#4-0-4"><span class="toc-number">1.115.</span> <span class="toc-text">
          4.0.4</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#4-0-3"><span class="toc-number">1.116.</span> <span class="toc-text">
          4.0.3</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#4-0-2"><span class="toc-number">1.117.</span> <span class="toc-text">
          4.0.2</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#4-0-1"><span class="toc-number">1.118.</span> <span class="toc-text">
          4.0.1</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#4-0-0"><span class="toc-number">1.119.</span> <span class="toc-text">
          4.0.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#3-1-2"><span class="toc-number">1.120.</span> <span class="toc-text">
          3.1.2</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#3-1-1"><span class="toc-number">1.121.</span> <span class="toc-text">
          3.1.1</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#3-1-0"><span class="toc-number">1.122.</span> <span class="toc-text">
          3.1.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#3-0-3"><span class="toc-number">1.123.</span> <span class="toc-text">
          3.0.3</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#3-0-2"><span class="toc-number">1.124.</span> <span class="toc-text">
          3.0.2</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#3-0-1"><span class="toc-number">1.125.</span> <span class="toc-text">
          3.0.1</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#3-0-0"><span class="toc-number">1.126.</span> <span class="toc-text">
          3.0.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#2-0-0"><span class="toc-number">1.127.</span> <span class="toc-text">
          2.0.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#1-5-0"><span class="toc-number">1.128.</span> <span class="toc-text">
          1.5.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#1-4-1"><span class="toc-number">1.129.</span> <span class="toc-text">
          1.4.1</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#1-4-0"><span class="toc-number">1.130.</span> <span class="toc-text">
          1.4.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#1-3-2"><span class="toc-number">1.131.</span> <span class="toc-text">
          1.3.2</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#1-3-1"><span class="toc-number">1.132.</span> <span class="toc-text">
          1.3.1</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#1-3-0"><span class="toc-number">1.133.</span> <span class="toc-text">
          1.3.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#1-2-3"><span class="toc-number">1.134.</span> <span class="toc-text">
          1.2.3</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#1-2-2"><span class="toc-number">1.135.</span> <span class="toc-text">
          1.2.2</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#1-2-1"><span class="toc-number">1.136.</span> <span class="toc-text">
          1.2.1</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#1-2-0"><span class="toc-number">1.137.</span> <span class="toc-text">
          1.2.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#1-1-0"><span class="toc-number">1.138.</span> <span class="toc-text">
          1.1.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#1-0-3"><span class="toc-number">1.139.</span> <span class="toc-text">
          1.0.3</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#1-0-2"><span class="toc-number">1.140.</span> <span class="toc-text">
          1.0.2</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#1-0-1"><span class="toc-number">1.141.</span> <span class="toc-text">
          1.0.1</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#1-0-0"><span class="toc-number">1.142.</span> <span class="toc-text">
          1.0.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#1-0-0-pre-7"><span class="toc-number">1.143.</span> <span class="toc-text">
          1.0.0-pre.7</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#1-0-0-pre-6"><span class="toc-number">1.144.</span> <span class="toc-text">
          1.0.0-pre.6</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#1-0-0-pre-5"><span class="toc-number">1.145.</span> <span class="toc-text">
          1.0.0-pre.5</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#1-0-0-pre-4"><span class="toc-number">1.146.</span> <span class="toc-text">
          1.0.0-pre.4</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#1-0-0-pre-3"><span class="toc-number">1.147.</span> <span class="toc-text">
          1.0.0-pre.3</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#1-0-0-pre-2"><span class="toc-number">1.148.</span> <span class="toc-text">
          1.0.0-pre.2</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#1-0-0-pre-1"><span class="toc-number">1.149.</span> <span class="toc-text">
          1.0.0-pre.1</span></a><ol class="toc-child"><li class="toc-item toc-level-3"><a class="toc-link" href="#Major-changes"><span class="toc-number">1.149.1.</span> <span class="toc-text">
          Major changes</span></a></li><li class="toc-item toc-level-3"><a class="toc-link" href="#Removed-jsdom-APIs"><span class="toc-number">1.149.2.</span> <span class="toc-text">
          Removed jsdom APIs</span></a></li><li class="toc-item toc-level-3"><a class="toc-link" href="#Changed-jsdom-APIs"><span class="toc-number">1.149.3.</span> <span class="toc-text">
          Changed jsdom APIs</span></a></li><li class="toc-item toc-level-3"><a class="toc-link" href="#Removed-non-standard-DOM-APIs"><span class="toc-number">1.149.4.</span> <span class="toc-text">
          Removed non-standard DOM APIs</span></a></li><li class="toc-item toc-level-3"><a class="toc-link" href="#Other-fixes"><span class="toc-number">1.149.5.</span> <span class="toc-text">
          Other fixes</span></a></li></ol></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-11-1"><span class="toc-number">1.150.</span> <span class="toc-text">
          0.11.1</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-11-0"><span class="toc-number">1.151.</span> <span class="toc-text">
          0.11.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-10-6"><span class="toc-number">1.152.</span> <span class="toc-text">
          0.10.6</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-10-5"><span class="toc-number">1.153.</span> <span class="toc-text">
          0.10.5</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-10-4"><span class="toc-number">1.154.</span> <span class="toc-text">
          0.10.4</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-10-3"><span class="toc-number">1.155.</span> <span class="toc-text">
          0.10.3</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-10-2"><span class="toc-number">1.156.</span> <span class="toc-text">
          0.10.2</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-10-1"><span class="toc-number">1.157.</span> <span class="toc-text">
          0.10.1</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-10-0"><span class="toc-number">1.158.</span> <span class="toc-text">
          0.10.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-9-0"><span class="toc-number">1.159.</span> <span class="toc-text">
          0.9.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-8-11"><span class="toc-number">1.160.</span> <span class="toc-text">
          0.8.11</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-8-10"><span class="toc-number">1.161.</span> <span class="toc-text">
          0.8.10</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-8-9"><span class="toc-number">1.162.</span> <span class="toc-text">
          0.8.9</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-8-8"><span class="toc-number">1.163.</span> <span class="toc-text">
          0.8.8</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-8-7"><span class="toc-number">1.164.</span> <span class="toc-text">
          0.8.7</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-8-6"><span class="toc-number">1.165.</span> <span class="toc-text">
          0.8.6</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-8-5"><span class="toc-number">1.166.</span> <span class="toc-text">
          0.8.5</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-8-4"><span class="toc-number">1.167.</span> <span class="toc-text">
          0.8.4</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-8-3"><span class="toc-number">1.168.</span> <span class="toc-text">
          0.8.3</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-8-2"><span class="toc-number">1.169.</span> <span class="toc-text">
          0.8.2</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-8-1-hotfix"><span class="toc-number">1.170.</span> <span class="toc-text">
          0.8.1 (hotfix)</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-8-0"><span class="toc-number">1.171.</span> <span class="toc-text">
          0.8.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-7-0"><span class="toc-number">1.172.</span> <span class="toc-text">
          0.7.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-6-5"><span class="toc-number">1.173.</span> <span class="toc-text">
          0.6.5</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-6-4"><span class="toc-number">1.174.</span> <span class="toc-text">
          0.6.4</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-6-3"><span class="toc-number">1.175.</span> <span class="toc-text">
          0.6.3</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-6-2"><span class="toc-number">1.176.</span> <span class="toc-text">
          0.6.2</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-6-1"><span class="toc-number">1.177.</span> <span class="toc-text">
          0.6.1</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-6-0"><span class="toc-number">1.178.</span> <span class="toc-text">
          0.6.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-5-7"><span class="toc-number">1.179.</span> <span class="toc-text">
          0.5.7</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-5-6"><span class="toc-number">1.180.</span> <span class="toc-text">
          0.5.6</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-5-5"><span class="toc-number">1.181.</span> <span class="toc-text">
          0.5.5</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-5-4"><span class="toc-number">1.182.</span> <span class="toc-text">
          0.5.4</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-5-3"><span class="toc-number">1.183.</span> <span class="toc-text">
          0.5.3</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-5-2"><span class="toc-number">1.184.</span> <span class="toc-text">
          0.5.2</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-5-1"><span class="toc-number">1.185.</span> <span class="toc-text">
          0.5.1</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-5-0"><span class="toc-number">1.186.</span> <span class="toc-text">
          0.5.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-4-2"><span class="toc-number">1.187.</span> <span class="toc-text">
          0.4.2</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-4-1-hotfix"><span class="toc-number">1.188.</span> <span class="toc-text">
          0.4.1 (hotfix)</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-4-0"><span class="toc-number">1.189.</span> <span class="toc-text">
          0.4.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-3-4"><span class="toc-number">1.190.</span> <span class="toc-text">
          0.3.4</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-3-3"><span class="toc-number">1.191.</span> <span class="toc-text">
          0.3.3</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-3-2"><span class="toc-number">1.192.</span> <span class="toc-text">
          0.3.2</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-3-1-hotfix"><span class="toc-number">1.193.</span> <span class="toc-text">
          0.3.1 (hotfix)</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-3-0"><span class="toc-number">1.194.</span> <span class="toc-text">
          0.3.0</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-2-19"><span class="toc-number">1.195.</span> <span class="toc-text">
          0.2.19</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-2-18"><span class="toc-number">1.196.</span> <span class="toc-text">
          0.2.18</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-2-17-hotfix"><span class="toc-number">1.197.</span> <span class="toc-text">
          0.2.17 (hotfix)</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-2-16"><span class="toc-number">1.198.</span> <span class="toc-text">
          0.2.16</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-2-15"><span class="toc-number">1.199.</span> <span class="toc-text">
          0.2.15</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-2-14"><span class="toc-number">1.200.</span> <span class="toc-text">
          0.2.14</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-2-13"><span class="toc-number">1.201.</span> <span class="toc-text">
          0.2.13</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-2-12"><span class="toc-number">1.202.</span> <span class="toc-text">
          0.2.12</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-2-11"><span class="toc-number">1.203.</span> <span class="toc-text">
          0.2.11</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-2-10"><span class="toc-number">1.204.</span> <span class="toc-text">
          0.2.10</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-2-9"><span class="toc-number">1.205.</span> <span class="toc-text">
          0.2.9</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-2-8-hotfix"><span class="toc-number">1.206.</span> <span class="toc-text">
          0.2.8 (hotfix)</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-2-7-hotfix"><span class="toc-number">1.207.</span> <span class="toc-text">
          0.2.7 (hotfix)</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-2-6"><span class="toc-number">1.208.</span> <span class="toc-text">
          0.2.6</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-2-5"><span class="toc-number">1.209.</span> <span class="toc-text">
          0.2.5</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-2-4"><span class="toc-number">1.210.</span> <span class="toc-text">
          0.2.4</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-2-3"><span class="toc-number">1.211.</span> <span class="toc-text">
          0.2.3</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-2-2"><span class="toc-number">1.212.</span> <span class="toc-text">
          0.2.2</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#0-2-1"><span class="toc-number">1.213.</span> <span class="toc-text">
          0.2.1</span></a></li></ol></li></ol></section><!-- ov = overview--><section class="sidebar-ov hide"><div class="sidebar-ov-author"><div class="sidebar-ov-author__avatar"><img class="sidebar-ov-author__avatar_img" src="/images/icons/cat.jpg" alt="avatar"></div><p class="sidebar-ov-author__text">Hello Stun</p></div><div class="sidebar-ov-state"><a class="sidebar-ov-state-item sidebar-ov-state-item--posts" href="/archives/"><div class="sidebar-ov-state-item__count">144</div><div class="sidebar-ov-state-item__name">Archives</div></a></div><div class="sidebar-ov-cc"><a href="https://creativecommons.org/licenses/by-nc-sa/4.0/deed.en" target="_blank" rel="noopener" data-popover="Creative Commons" data-popover-pos="up"><img src="/images/cc-by-nc-sa.svg"></a></div></section><div class="sidebar-reading"><div class="sidebar-reading-info"><span class="sidebar-reading-info__text">You have read </span><span class="sidebar-reading-info__num">0</span><span class="sidebar-reading-info__perc">%</span></div><div class="sidebar-reading-line"></div></div></aside></div><div class="clearfix"></div></div></main><footer class="footer" id="footer"><div class="footer-inner"><div><span>Copyright © 2023</span><span class="footer__icon"><i class="fas fa-heart"></i></span><span>汪汪队</span></div><div><span>Powered by <a href="http://hexo.io/" title="Hexo" target="_blank" rel="noopener">Hexo</a></span><span> v6.3.0</span><span class="footer__devider">|</span><span>Theme - <a href="https://github.com/liuyib/hexo-theme-stun/" title="Stun" target="_blank" rel="noopener">Stun</a></span><span> v2.8.0</span></div></div></footer><div class="loading-bar" id="loading-bar"><div class="loading-bar__progress"></div></div><div class="back2top" id="back2top"><span class="back2top__icon"><i class="fas fa-rocket"></i></span></div></div><script src="https://cdn.jsdelivr.net/npm/jquery@v3.4.1/dist/jquery.min.js"></script><script src="https://cdn.jsdelivr.net/npm/velocity-animate@1.5.2/velocity.min.js"></script><script src="https://cdn.jsdelivr.net/npm/velocity-animate@1.5.2/velocity.ui.min.js"></script><script src="/js/utils.js?v=2.8.0"></script><script src="/js/stun-boot.js?v=2.8.0"></script><script src="/js/scroll.js?v=2.8.0"></script><script src="/js/header.js?v=2.8.0"></script><script src="/js/sidebar.js?v=2.8.0"></script></body></html>